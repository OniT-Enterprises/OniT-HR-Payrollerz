...
exports.advanceRecurringInvoiceDate = advanceRecurringInvoiceDate;
function daysInMonth(year, monthIndex) {
    return new Date(Date.UTC(year, monthIndex + 1, 0)).getUTCDate();
}
/**
 * Server-side mirror of the client schedule helper. Month arithmetic happens
 * before constructing the Date so Jan 31 advances to February, not March.
 */
function advanceRecurringInvoiceDate(currentDate, frequency, anchorDate = currentDate) {
...
//# sourceMappingURL=recurringInvoiceSchedule.js.map