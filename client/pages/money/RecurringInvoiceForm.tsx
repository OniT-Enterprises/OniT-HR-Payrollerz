                  ...
                  <table className="w-full">
                    <thead className="bg-muted/50">
                      <tr>
                        ...
                        <th className="text-right p-3 w-24"><Skeleton className="h-4 w-8 ml-auto" /></th>
                        <th className="text-right p-3 w-32"><Skeleton className="h-4 w-10 ml-auto" /></th>
                        <th className="text-right p-3 w-32"><Skeleton className="h-4 w-14 ml-auto" /></th>
