const messages = {
  ...
  "settings": {
    ...
    "timeOff": {
      ...
      "probationHint": "Lisensa anual la bele hahú antes empregadu kompleta fulan hirak-ne'e. Na'in no admin RH bele halo eksesaun ba pedidu ida.",
      "months": "fulan",
  ...
  "hiring": {
    ...
    "offboarding": {
      ...
      "finalPay": {
        ...
        "subsidioNote": "Referénsia de'it — prosesamentu salariál tuirmai ba trabalhadór ne'e selu automatikamente indemnizasaun + fulan 13 proporsionál ne'e (menus buat ne'ebé selu tiha ona). Labele selu manualmente tan.",
  ...
  "accounting": {
    ...
    "recurring": {
      ...
      "description": "Lansamentu jornál ne'ebé Xefe rejista ba Ita kada fulan — akrésimu renda, amortizasaun, ajustamentu fixu.",
      "empty": "Seidauk iha lansamentu rekorrente. Loke lansamentu ida ne'ebé rejista ona no hili \"Halo rekorrente\".",
      "paused": "Para hela",
      ...
      "deleteDescription": "\"{{name}}\" sei para rejista. Lansamentu ne'ebé rejista tiha ona kontinua iha jornál.",
      "makeRecurringTitle": "Halo lansamentu ida-ne'e rekorrente",
      "makeRecurringDescription": "Xefe sei rejista kópia husi {{ref}} kada fulan, iha loron ne'ebé Ita hili.",
