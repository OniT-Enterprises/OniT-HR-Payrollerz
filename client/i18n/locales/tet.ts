const messages = {
  ...
  nav: {
    ...
    financeReports: "Finansas no relatóriu",
  ...
  dashboard: {
    ...
    botSummaryFirstRun:
      "Mai hatama membru ekipa dahuluk atu Xefe bele hahú servisu.",
    firstRunTitle: "Mai konfigura ita-nia ekipa",
    firstRunDesc:
      "Hatama ema ne'ebé servisu ba ita. Bainhira sira iha ona, Xefe kalkula sira-nia saláriu, impostu no INSS.",
    firstRunAction: "Hatama funsionáriu dahuluk",
    firstRunSetupLink: "Remata konfigurasaun Xefe",
    ...
    simple: {
      ...
      features: {
        ...
        people: {
          title: "Ema no tempu",
          description:
            "Rai rejistu funsionáriu, prezensa no lisensa hamutuk. Staf bele haree payslip no husu lisensa iha Ekipa.",
        },
        payroll: {
  ...
  enginePage: {
    ...
    hero: {
      ...
      description:
        "Xefe nia ekran simples tanba parte difísil hela iha motór laran: lei laboral, impostu no seguransa sosiál Timor-Leste nian, implementadu regra ida-idak no verifikadu ho oinsá folha pagamentu halo loloos iha rai laran.",
    ...
    pipeline: {
      ...
      steps: {
        ...
        file: {
          title: "Deklara",
          description:
            "Declaração de Remunerações INSS iha formatu ofisiál no formuláriu impostu mensál ATTL prepara an rasik, ho detallu pagamentu prenxe ona no data limite ajustadu ba loron servisu tuir mai iha Timor-Leste.",
        },
        pay: {
          title: "Selu",
          description:
    ...
    cta: {
      ...
      description:
        "Konfigura grátis: aumenta Ita-nia ekipa, halo folha rascunhu ida, no haree númeru hotu iha pájina ne'e iha Ita-nia livru rasik. Ita subskreve de'it bainhira finaliza folha reál.",
  ...
  howItWorks: {
    ...
    workflow: {
      ...
      payments: {
        ...
        description:
          "Konfirma data pagamentu. Resibu, ficheiru banku no dokumentu WIT no INSS sai husi folha aprovadu.",
      },
      accounting: {
        title: "Mantén livru kontabil atualizadu",
        description:
          "Folha aprovadu lansa hanesan lansu kontabil balansadu. Livru jerál, balansu prova no demonstrasaun sira atualizadu nafatin.",
      },
      verifyNote:
    ...
    controls: {
      ...
      items: {
        ...
        journals: {
          ...
          description:
            "Folha aprovadu kria liña kontabil balansadu, ligadu fali ba folha orijinal.",
        },
        audit: {
  ...
  settings: {
    ...
    access: {
      ...
      role: "Papél",
      managerDepartment: "Jestór nia departamentu",
      chooseDepartment: "Hili departamentu ida",
      managerDepartmentHint: "Jestór ne'e bele superviziona prezensa ba departamentu ida-ne'e.",
      managerDepartmentsError: "Labele karrega departamentu sira. Koko fali.",
      noManagerDepartments: "Kria departamentu antes atribui jestór.",
    ...
    hub: {
      groupBusiness: "Ita-nia negósiu",
      groupTeam: "Ita-nia ekipa",
      companyLabel: "Detalle empresa",
      companyDesc: "Naran, enderesu, telefone no logo ita-nia empresa.",
      paymentsLabel: "Oinsá selu ita-nia funsionáriu",
      paymentsDesc:
        "Osan ka transferénsia banku, konta banku, no dala hira selu.",
      billingLabel: "Ita-nia planu Xefe",
      billingDesc: "Xefe kusta hira, no oinsá ita selu.",
      accessLabel: "Sé mak bele uza Xefe",
      accessDesc: "Konvida ema, muda saida sira bele loke, ka fó senha foun.",
      timeOffLabel: "Lisensa no feriadu",
      timeOffDesc:
        "Loron lisensa kada tinan, atestadu moras, no feriadu públiku.",
      advancedTitle: "Konfigurasaun avansadu",
      advancedCaution:
        "Sira-ne'e tuir ona lei Timor-Leste. Muda deit se ita-nia kontabilista husu.",
      payrollRulesLabel: "Regra impostu, INSS no oras estra",
      payrollRulesDesc: "Valór ne'ebé Xefe uza atu kalkula saláriu.",
      accountantLabel: "Ita-nia kontabilista",
      accountantDesc:
        "Fó asesu ba ita-nia kontabilista, ka haruka livru ba QuickBooks.",
      finishSetupTitle: "Remata konfigurasaun Xefe",
      finishSetupDesc:
        "Pergunta balu kona-ba ita-nia negósiu, depois ita bele prosesa folha.",
    },
    tabs: {
      company: "Empresa",
      structure: "Estrutura",
    ...
    company: {
      sectionPlaces: "Fatin servisu no ekipa",
      sectionPlacesDesc:
        "Fatin servisu no ekipa ne'ebé ita grupu funsionáriu ba.",
      teamsSavedNote: "Ekipa rai kedas bainhira ita hatama ka hasai.",
      taxNumbersTitle: "Númeru impostu no rejistu",
      sectorSeedsNote: "Hili setór ida hatama lista ekipa inisiál.",
    ...
    timeOff: {
      ...
      rows: {
        ...
        sick: {
          ...
          certificateOff:
            "Ita-nia empreza taka tiha ida-ne'e, maibé lei husu sertifikadu médiku ba lisensa doensa.",
    ...
    notifications: {
      ...
      holidayLoadFailed: "La bele karrega feriadu ne'ebé muda ona.",
      holidaySaved: "Mudansa feriadu rai ona.",
      holidaySaveFailed: "La bele rai mudansa feriadu.",
      holidayRemoved: "Mudansa feriadu hasai ona.",
      holidayRemoveFailed: "La bele hasai mudansa feriadu.",
      holidayName: "Feriadu",
      ...
      builtIn: "Padraun",
      edit: "Edita",
      removeOverride: "Hasai mudansa",
      addOverrideHoliday: "Aumenta ka muda feriadu (Tolerânsia)",
      nameTetun: "Naran (Tetun)",
      notes: "Nota",
      notesPlaceholder: "Opsional (ex: referensia dekretu governu)",
      clear: "Hamoos",
      saveOverride: "Rai mudansa",
    },
  },
  employees: {
    profile: {
      ...
      appInvite: "Konvite ba app",
      inviteSending: "Haruka hela…",
      inviteSentTitle: "Konvite ba app haruka ona",
      inviteSentDesc:
        "{{email}} sei simu e-mail atu tau senha no tama ba Ekipa.",
      inviteExistsTitle: "Iha asesu ona",
      inviteExistsDesc:
        "{{email}} sai membru ona — nia bele tama ka uza “Haluha senha”.",
      ...
      fixedTermElapsed:
        "Kontrata iha {{date}} ho kontratu ho prazu. Tuir Lei Trabálhu Timor-Leste, servisu ho prazu ne'ebé kontinua liu tinan 3 sai permanente tuir lei. Haree fila fali no konverte kontratu ne'e.",
      fixedTermSpan:
        "Kontratu ne'e, tuir data ({{from}} to'o {{to}}), liu tinan 3. Tuir Lei Trabálhu Timor-Leste, servisu ho prazu la bele liu tinan 3 inklui renovasaun — sai permanente tuir lei. Haree fila fali no konverte kontratu ne'e.",
      convertNow: "Konverte agora",
      converting: "Konverte hela…",
      convertedTitle: "Kontratu konverte ona",
      convertedDesc:
        "Rejistu traballadór nian sai permanente ona no data remata kontratu ho prazu hamoos tiha.",
      convertFailedTitle: "La bele konverte kontratu",
      renewedTimes: "Renova dala {{count}}",
      leaveRemaining: "{{count}} sei iha",
      leaveUsed: "{{count}} goza ona",
      leavePending: "{{count}} hein hela",
      ...
      documentUploaded: "Dokumentu hatama ona",
      uploadedOn: "Hatama iha {{date}}",
      uploadContract: "Hatama kontratu",
      workingVisa: "Vistu servisu / residênsia",
      uploadVisa: "Hatama dokumentu vistu",
      addVisa: "Tau dadus vistu",
      expired: "Remata iha {{date}}",
      expiresIn: "Remata iha loron {{count}}",
      expiresOn: "Remata iha {{date}}",
      unknownError: "Sala la hatene",
    },
  ...
  timeLeave: {
    timeTracking: {
      ...
      edit: {
        ...
        deleteDesc:
          "Ida ne'e sei hamoos rejistu prezensa ba {{name}} iha {{date}}. La bele halo fali.",
        deleteConfirm: "Apaga",
    ...
    attendance: {
      ...
      empty: {
        ...
        instructions:
          "Uza butaun iha leten atu marka prezensa manual, ka importa rejistu husi dispozitivu biometriku.",
      ...
      toast: {
        ...
        importAiDesc:
          "Formatu la hanesan, entaun XefeBot normaliza — rekoñese rejistu {{count}}.",
        importCompleteTitle: "Importa remata",
        importCompleteDesc:
          "{{success}} rejistu importa, {{duplicates}} duplikadu salta, {{errors}} erru.",
    ...
    shiftScheduling: {
      ...
      toast: {
        ...
        copiedWithSkippedDesc:
          "Turnu {{count}} kopia ba semana oin mai nudar rascunhu. {{skipped}} la kopia (agenda ona ka iha lisensa).",
  ...
  accounting: {
    ...
    journalEntries: {
      ...
      subtitle:
        "Lansamentu Kontabilidade - Reviza entrada kontabilidade husi saláriu no operasaun",
    ...
    dashboard: {
      ...
      accountantGateEnableHint:
        "Na'in empresa bele hamoris ekran sira-ne'e iha Konfigurasaun → Modu impostu avansadu.",
  ...
  reports: {
    ...
    attendance: {
      ...
      recent: {
        ...
        emptyDescription:
          "Rejistu sei mosu iha ne'e bainhira empregadu tama ka sai",
      },
    },
    shared: {
      periodLabel: "Períodu",
  ...
  runPayroll: {
    ...
    inssEmployerLabel: "INSS Empreza ({{rate}}%)",
    ...
    syncAttendanceDesc:
      "Karu dadus oras regular, overtime no atrasu hosi prezensa ba períodu ida-ne'e.",
    ...
    employerCostHint: "Brutu + INSS Empreza ({{rate}}%)",
    ...
    toastSyncedAttendance:
      "Dadus prezensa sinkroniza ba trabalhador {{count}}.",
    toastSyncedAttendanceWithLeave:
      "Dadus prezensa sinkroniza ba trabalhador {{count}}. Lisensa aprovadu kredita ba ema {{leaveCount}} — lisensa selu nian la kona deskontu.",
    toastSyncLeaveLookupFailed:
      "La bele karga lisensa aprovadu, entaun sinkronizasaun kansela — se lae, trabalhador iha lisensa selu nian sei simu osan menus. Xeke koneksaun no koko fali.",
  ...
  paymentOrders: {
    ...
    downloadedDescription:
      "Imprime, prienxe númeru OT, asina, no haruka liu husi email ba Ita-nia balkaun banku.",
    failed: "La konsege kria ordem de pagamentu.",
  },
  payrollHistory: {
    cashPaid: {
      action: "Selu ho osan",
      title: "Rejista pagamentu ho osan",
      description:
        "Konfirma katak ita selu ona saláriu sira-ne'e ho osan. Xefe rejista pagamentu iha ita-nia livru no folha ne'e sei konta ba deklarasaun INSS no impostu.",
      dateLabel: "Loron ne'ebé ita selu",
      referenceLabel: "Referénsia",
      referencePlaceholder: "ez.: Pagamentu ho osan, folha asinadu",
      referenceHelp:
        "Buat ida ne'ebé ita bele hetan fali ikus mai — númeru resibu ka folha pagamentu ne'ebé asina ona.",
      confirm: "Sin, sira simu ona",
      successTitle: "Folha marka ona nu'udar selu tiha",
      successDesc:
        "Pagamentu ho osan rai ona, entaun folha ne'e konta ona ba deklarasaun INSS no impostu.",
      errorTitle: "La bele rejista pagamentu",
      errorDesc: "Favór koko fila fali.",
    },
  ...
  bankTransfers: {
    ...
    coverEmail: {
      ...
      description:
        "BNU prosesa lote saláriu husi instrusaun liu husi email. Ba BNCTL, pakote ida-ne'e best-effort to'o Ita-nia balkaun konfirma. Haruka ficheiru no anexa folha Ordem de Pagamento ne'ebé imprime no asina ona.",
  ...
  taxReports: {
    ...
    filedFiguresFrozenDescription:
      "{{period}} hatama tiha ona, tan ne'e númeru sira ne'ebé deklara ona nafatin hanesan. Ida ne'ebé ita haree mak folha atuál, la'ós deklarasaun ne'ebé hatama ona.",
  ...
  moduleDashboards: {
    ...
    accounting: {
      ...
      allGoodWithPayroll:
        "Kontas balansu ona no saláriu lansa ona — laiha buat ne'ebé presiza atensaun.",
