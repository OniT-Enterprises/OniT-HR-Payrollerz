const messages = {
  ...
  settings: {
    ...
    access: {
      ...
      managerDepartmentHint: "This manager can supervise attendance for this department.",
      managerDepartmentsError: "Departments could not be loaded. Try again.",
      noManagerDepartments: "Create a department before assigning a manager.",
  ...
  employees: {
    profile: {
      ...
      notFound: "We could not find that employee. They may have been removed.",
      backToEmployees: "All employees",
      sectionPersonal: "Who they are",
      sectionJob: "What they do and what you pay them",
      appInvite: "App invite",
      inviteSending: "Sending\u2026",
      inviteSentTitle: "App invite sent",
      inviteSentDesc:
        "{{email}} will receive an email to set their password and sign in to Ekipa.",
      inviteExistsTitle: "Already has access",
      inviteExistsDesc:
        "{{email}} is already a member \u2014 they can sign in or use \u201cForgot password\u201d.",
      inviteFailedTitle: "Could not send invite",
      cvPdf: "CV PDF",
      ...
      convertedTitle: "Contract converted",
      convertedDesc:
        "The employee record is now marked permanent and the fixed-term end date was cleared.",
      convertFailedTitle: "Could not convert contract",
      renewedTimes: "Renewed {{count}} time(s)",
      leaveRemaining: "{{count}} remaining",
      leaveUsed: "{{count}} used",
      leavePending: "{{count}} pending",
      noNationality: "No nationality yet",
      docSocialSecurity: "Social Security Number",
      docTin: "Worker NIF / TIN",
      docElectoral: "Electoral Card",
      docIdCard: "ID Card",
      ...
      workingVisa: "Working visa / residency",
      uploadVisa: "Upload visa document",
      addVisa: "Add visa details",
  ...
  runPayroll: {
    ...
    inssEmployerLabel: "INSS Employer ({{rate}}%)",
    ...
    employerCostHint: "Gross + INSS Employer ({{rate}}%)",
