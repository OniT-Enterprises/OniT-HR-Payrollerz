const messages = {
  ...
  "settings": {
    ...
    "timeOff": {
      ...
      "probationHint": "Annual leave cannot start before the employee has completed this many months. Owners and HR admins can override on a specific request.",
      "months": "months",
  ...
  "hiring": {
    ...
    "offboarding": {
      ...
      "finalPay": {
        ...
        "subsidioNote": "Reference only — the leaver's next payroll run pays severance + this prorated 13th month automatically (net of anything already paid). Don't settle these manually too.",
  ...
  "timeLeave": {
    ...
    "attendance": {
      ...
      "import": {
        ...
        "importing": "Importing...",
        "skippedSummary": "{{count}} of {{total}} rows were skipped and not imported",
        "rowLabel": "Row",
  ...
  "accounting": {
    ...
    "recurring": {
      ...
      "empty": "No recurring entries yet. Open a posted entry and choose \"Make recurring\".",
      "paused": "Paused",
      ...
      "deleteDescription": "\"{{name}}\" will stop posting. Entries it already posted stay in the journal.",
      "makeRecurringTitle": "Make this entry recurring",
      "makeRecurringDescription": "Xefe will post a copy of {{ref}} every month, on the day you choose.",
