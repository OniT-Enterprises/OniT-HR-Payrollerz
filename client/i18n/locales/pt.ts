const messages = {
  ...
  "settings": {
    ...
    "timeOff": {
      ...
      "probationHint": "As férias anuais não podem começar antes de o funcionário completar estes meses. Proprietários e administradores de RH podem abrir exceção num pedido específico.",
      "months": "meses",
