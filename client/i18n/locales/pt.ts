const messages = {
  legal: {
    ...
    privacy: {
      ...
      intro:
        "O Xefe é um serviço de RH e folha de pagamento operado em Timor-Leste. Esta página explica que informações o serviço guarda e como são usadas.",
      s1Title: "Informações que guardamos",
      s1Body:
        "Dados da conta, como nome e email, e os registos que o seu empregador introduz para gerir o negócio — perfis de funcionários, números de documentos de identidade, salários, assiduidade, licenças e histórico de folhas de pagamento. Se se candidatar a um emprego através de um link público, guardamos a candidatura que submeter, incluindo o seu CV.",
      s2Title: "Como são usadas",
      s2Body:
        "Apenas para prestar o serviço — calcular folhas de pagamento, acompanhar licenças e assiduidade, e produzir recibos e relatórios. Não vendemos as suas informações nem as partilhamos com anunciantes.",
      s3Title: "Quem pode ver",
      s3Body:
        "Os administradores autorizados do seu empregador controlam os registos da empresa. A equipa do Xefe só acede aos dados para suporte e manutenção, e esse acesso fica registado num registo de auditoria.",
      s4Title: "Onde são guardadas",
      s4Body:
        "Os dados são guardados no Google Firebase e protegidos com encriptação em trânsito e em repouso, além de regras de acesso por empresa.",
      s5Title: "Por quanto tempo as guardamos",
      s5Body:
        "Os registos são mantidos enquanto a conta do empregador estiver ativa. Os registos de folha de pagamento podem ser mantidos por mais tempo quando a lei de Timor-Leste o exigir. Os empregadores podem pedir a eliminação da conta da empresa e dos seus dados.",
      s6Title: "Os seus direitos",
      s6Body:
        "Se é funcionário, peça ao administrador do seu empregador para ver ou corrigir as suas informações — é o empregador que controla esses registos. Os candidatos a emprego podem contactar a empresa à qual se candidataram.",
      s7Title: "Dúvidas",
    ...
    terms: {
      ...
      s1Title: "O serviço",
      s1Body:
        "O Xefe fornece ferramentas de RH, folha de pagamento e contabilidade para empresas em Timor-Leste, incluindo cálculos de WIT e INSS com base nas taxas que configurar.",
      s2Title: "As suas responsabilidades",
      s2Body:
        "É responsável pela exatidão das informações que introduz, por ter o direito de guardar as informações dos seus funcionários e por verificar os valores da folha antes de pagar ou declarar às autoridades. O Xefe é uma ferramenta — não é aconselhamento jurídico ou fiscal.",
      s3Title: "Os seus dados",
      s3Body:
        "Os dados da sua empresa pertencem-lhe. Pode exportá-los a qualquer momento e pedir a eliminação da sua conta.",
      s4Title: "Uso aceitável",
      s4Body:
        "Não use o serviço para fins ilegais, não tente aceder aos dados de outras empresas e não interfira com o funcionamento do serviço.",
      s5Title: "Disponibilidade",
      s5Body:
        "Trabalhamos para manter o serviço disponível e os seus dados seguros, mas o serviço é fornecido “tal como está”, sem garantias, e não somos responsáveis por perdas indiretas, como lucros cessantes.",
      s6Title: "Alterações a estes termos",
      s6Body:
        "Podemos atualizar estes termos. Alterações significativas serão anunciadas na aplicação; continuar a usar o serviço significa que as aceita.",
  ...
  common: {
    ...
    connectionIssueDesc:
      "O sinal está fraco. Mantenha esta página aberta e tente novamente quando a internet estabilizar.",
    accountRecoveryTitle: "Não foi possível abrir a sua conta",
    accountRecoveryDesc:
      "Não foi possível carregar esta conta. Tente novamente ou use outra conta.",
  ...
  nav: {
    ...
    financeReports: "Finanças e relatórios",
    ...
    companySettingsLinkDesc:
      "Dados da empresa, locais de trabalho e departamentos",
    paymentsSettingsLink: "Pagamentos e Bancos",
    paymentsSettingsLinkDesc:
      "Contas bancárias, métodos de pagamento e calendário da folha",
    integrationsSettingsLink: "Contabilista e Integrações",
    integrationsSettingsLinkDesc:
      "Exportação QuickBooks, modo fiscal avançado e acesso do contabilista",
  ...
  allowances: {
    title: "Subsídios",
    subtitle:
      "Gerir subsídios e benefícios dos funcionários — os subsídios ativos entram automaticamente em cada folha",
    ...
    allowanceAddedDesc:
      "Subsídio de {{type}} de {{amount}} adicionado com sucesso",
    ...
    missingInfoDesc:
      "Por favor selecione um funcionário, tipo de subsídio e introduza um montante",
    ...
    confirmRemoveDesc:
      "Isto irá terminar o subsídio. Já não será incluído em futuras folhas de pagamento.",
  ...
  dashboard: {
    cardPayrollOverdue:
      "Salários em atraso — o art. 40.º exige pagamento pelo menos mensal",
    ...
    todoBlockingDesc:
      "{{count}} funcionário(s) precisam de documentos ou dados.",
    todoAddEmployeeDesc: "Adicione um novo membro à sua organização.",
    botBriefing: "resumo",
    botGreeting:
      "Sou o XefeBot — pergunte sobre a equipa, folha, licenças ou qualquer coisa.",
    botGreeting2:
      "Precisa de uma resposta rápida? Posso consultar dados de funcionários, folha ou licenças.",
    botGreeting3:
      "Estou aqui para ajudar — pergunte sobre a sua equipa ou prazos futuros.",
    botGreeting4:
      "O seu assistente está pronto. Pergunte o que quiser sobre a organização.",
    ...
    donorExport: "Exportação para Doadores",
    ngoReportingHint:
      "ONG: abra rapidamente as ferramentas de alocação por projeto/financiamento e exportação para doadores.",
    ...
    simpleOverviewDesc:
      "Use estes três cartões para as tarefas mais importantes de hoje.",
  ...
  documentAlerts: {
    ...
    subtitle:
      "Monitorizar e gerir documentos de funcionários prestes a expirar",
  ...
  announcements: {
    ...
    empty: {
      ...
      description:
        "Crie o seu primeiro anúncio para o transmitir a todos os funcionários via Ekipa.",
    },
    table: {
      title: "Título",
      body: "Conteúdo",
    ...
    dialog: {
      ...
      newDescription:
        "Isto ficará visível para todos os funcionários na aplicação Ekipa.",
      ...
      emailHint:
        "Envia email a todos os funcionários ativos com email registado.",
    },
    delete: {
      title: "Eliminar anúncio",
      description:
        'Tem a certeza de que quer eliminar "{{title}}"? Esta ação não pode ser desfeita e o anúncio será removido dos feeds Ekipa de todos os funcionários.',
    },
    toast: {
      ...
      emailNoRecipients:
        "Nenhum funcionário tem email registado — ninguém recebeu email",
  ...
  auth: {
    ...
    forgotPasswordSubtitle:
      "Introduza o seu email e enviaremos uma ligação para a repor",
    ...
    resetEmailSentDetail:
      "Se existir uma conta para {{email}}, uma ligação de reposição está a caminho.",
    ...
    errors: {
      ...
      companySlugTaken:
        "Esse endereço de empresa já está em uso. Escolha outro.",
      networkTimeout:
        "Está a demorar demasiado — verifique a sua ligação à internet e tente novamente.",
      ...
      resetFailed:
        "Não foi possível enviar o email de reposição. Tente novamente.",
  ...
  unauthorized: {
    ...
    message:
      "Esta área está reservada a administradores da plataforma. Se acha que isto está incorreto, contacte um superadmin ou volte para a aplicação principal.",
    backHome: "Voltar ao Início",
  ...
  billing: {
    ...
    subtitle:
      "Todas as funcionalidades são gratuitas. A subscrição desbloqueia a finalização da folha de pagamento.",
    active: {
      title: "Subscrição ativa",
      description:
        "Pode finalizar folhas de pagamento e usar todas as funcionalidades.",
    },
    free: {
      title: "Subscreva para processar salários",
      description:
        "Está no plano gratuito — tudo funciona exceto finalizar uma folha de pagamento.",
    },
    interval: {
      monthly: "Mensal",
      annual: "Anual",
    ...
    seatNote: {
      monthly:
        "A sua fatura ajusta-se automaticamente quando a equipa muda — cada fatura cobra o tamanho da equipa nesse momento, sem cobranças parciais do mês.",
      monthlyChanged:
        "A sua equipa mudou desde a última fatura — a próxima cobra {{count}} funcionários ({{total}}/mês). Sem cobranças parciais do mês.",
      annual:
        "A sua fatura ajusta-se automaticamente quando a equipa muda — funcionários adicionados são cobrados logo com um pequeno valor proporcional; reduções aplicam-se na renovação.",
      annualIncrease:
        "Funcionários adicionados são faturados automaticamente — receberá uma pequena fatura proporcional pela diferença, e a renovação cobra {{count}} funcionários ({{total}}/ano).",
      manual:
        "O seu preço fica fixo até à data de validade. Ao renovar, o novo valor usa o tamanho da equipa nesse momento.",
    },
    paidUntil: "Pago até",
    renews: "Renova",
    manageBilling: "Gerir faturação",
    manualContact:
      "Pago por transferência bancária ou dinheiro. Para renovar ou alterar, envie email para",
    subscribeMonthly: "Subscrever mensal",
    subscribeAnnually: "Subscrever anual",
    stripeSecure:
      "Os pagamentos com cartão são processados com segurança pela Stripe.",
    offline: {
      title: "Sem cartão? Pague por transferência bancária ou dinheiro.",
      description:
        "Peça uma fatura e enviaremos os dados de pagamento. A subscrição é ativada assim que o pagamento for confirmado.",
      request: "Pedir uma fatura",
      sent: "Pedido enviado ✓",
    },
    onlyAdmins:
      "Só proprietários e administradores de RH podem alterar a subscrição.",
    toasts: {
      ...
      requestSent:
        "Pedido enviado — enviaremos a sua fatura com os dados de pagamento.",
  ...
  landing: {
    ...
    simple: {
      ...
      hero: {
        ...
        description:
          "O Xefe calcula IRT, INSS, horas extra e subsídio anual, depois prepara ficheiros bancários e recibos — sem folhas de cálculo.",
      ...
      workflow: {
        ...
        description:
          "Configure a equipa uma vez. O Xefe repete os cálculos em cada período de pagamento.",
        steps: {
          add: {
            title: "Adicione os funcionários",
            description:
              "Introduza salário, horário e dados de pagamento num único registo guiado.",
          },
          calculate: {
            title: "Reveja o cálculo",
            description:
              "IRT, INSS, horas extra, subsídios e acumulação do 13.º mês são calculados em conjunto.",
          },
          pay: {
            title: "Pague e partilhe",
            description:
              "Aprove a folha, descarregue ficheiros bancários e entregue um recibo claro a cada funcionário.",
          },
        },
      },
      features: {
        ...
        description:
          "Comece pela folha. Acrescente pessoas, faturação e contabilidade conforme a empresa precisar.",
        people: {
          title: "Pessoas e tempo",
          description:
            "Mantenha registos, assiduidade e licenças juntos. A equipa pode ver recibos e pedir licenças no Ekipa.",
        },
        payroll: {
          title: "Folha e bancos locais",
          description:
            "Calcule salários, reveja descontos e prepare ficheiros para bancos de Timor-Leste na mesma folha.",
        },
        invoices: {
          title: "Faturas e pagamentos do dia a dia",
          description:
            "Crie faturas de clientes e registe pagamentos em dinheiro, transferência, cartão, dinheiro móvel ou cheque.",
        },
      ...
      local: {
        ...
        description:
          "Regras, bancos e idiomas locais fazem parte do produto — não são um extra.",
        compliance: {
          title: "IRT, INSS e subsídio incluídos",
          description:
            "Calcule descontos, contribuições do empregador, horas extra e acumulação do subsídio anual numa folha revista.",
        },
        banks: {
          title: "Ficheiros para bancos locais",
          description:
            "Use o pacote salarial BNU verificado, com exportações BNCTL, Mandiri e ANZ claramente marcadas como estimativas a confirmar.",
        },
        languages: {
        ...
        payslipDescription:
          "Cada folha cria um detalhe claro que pode ser visto no telefone ou descarregado em PDF.",
      },
      pricing: {
        eyebrow: "Preço simples",
        title: "Um preço. Todas as funcionalidades incluídas.",
        description:
          "Configure a empresa e prepare a folha gratuitamente. Subscreva apenas quando estiver pronto para finalizar uma folha real.",
        perEmployeeMonth: "/funcionário/mês",
        example: "Exemplo: {{total}}/mês para {{employees}} funcionários",
        billedMonthly: "faturado mensalmente",
        minimum:
          "O mínimo mensal de {{total}} inclui {{employees}} funcionários",
        ...
        freeNote:
          "As contas gratuitas podem usar todas as funcionalidades. A subscrição permite finalizar folhas de pagamento.",
        cardPaymentTitle: "Pague online por cartão",
        cardPaymentDescription:
          "O checkout e a faturação segura da subscrição são tratados pelo Stripe.",
        localPaymentTitle: "Prefere um pagamento local?",
        localPaymentDescription:
          "Pergunte-nos sobre pagar o Xefe por fatura, transferência bancária ou dinheiro.",
      ...
      support: {
        ...
        description:
          "Receba ajuda para configurar funcionários, regras da folha e o primeiro ficheiro bancário de quem entende as empresas locais.",
        primary: "Começar grátis",
      ...
      founding: {
        ...
        description:
          "Estamos a integrar as primeiras empresas de Timor-Leste. Registe-se agora e use folha de pagamento, pessoas e contabilidade grátis durante 6 meses — com configuração e apoio local.",
  ...
  securityPage: {
    ...
    hero: {
      ...
      description:
        "Tudo nesta página está a funcionar hoje — não é um roteiro. É a camada de segurança debaixo de cada folha, fatura e lançamento no Xefe.",
    },
    controls: {
      eyebrow: "Controlos reais",
      title: "Impostos no servidor, não só no ecrã",
      description:
        "Esconder um botão não é segurança. As regras do Xefe vivem na camada da base de dados, onde não podem ser contornadas.",
      cards: {
        rules: {
          title: "Regras de segurança no servidor",
          description:
            "Cada leitura e escrita passa por regras de isolamento impostas pela própria base de dados. A interface nunca é a única barreira.",
        },
        twoPerson: {
          title: "Duas pessoas para finalizar a folha",
          description:
            "Quem prepara uma folha não a pode aprovar — salvo se a empresa optar explicitamente pelo modo individual. A regra é imposta na base de dados, não na app.",
        },
        billing: {
    ...
    data: {
      ...
      description:
        "O Xefe corre no Google Cloud (Firebase), com os registos da sua empresa isolados de todos os outros clientes.",
      ...
      points: {
        encryption: {
          ...
          description:
            "Todo o tráfego é encriptado por TLS e tudo o que é guardado é encriptado em repouso pelo Google Cloud.",
        },
        backups: {
          title: "Backups diários + recuperação pontual",
          description:
            "Backups automáticos diários, com recuperação point-in-time ativa para restaurar registos a um momento preciso.",
        },
        isolation: {
        ...
        audit: {
          ...
          description:
            "Aprovações de folha, ações administrativas e lançamentos contabilísticos ficam registados com quem fez o quê, e quando.",
        },
      },
    },
    privacy: {
      ...
      description:
        "Dados salariais são a coisa mais sensível que uma empresa guarda. Os padrões do Xefe tratam-nos assim.",
      points: {
        email: {
          title: "Um destinatário por email",
          description:
            "Cada notificação sai individualmente — os funcionários nunca veem os endereços uns dos outros.",
        },
        links: {
          title: "Links impossíveis de adivinhar, revogáveis",
          description:
            "As páginas públicas de faturas usam links longos e aleatórios que não podem ser listados — e pode desativar um link a qualquer momento.",
        },
        roles: {
        ...
        payslips: {
          ...
          description:
            "O recibo de cada trabalhador vai só para esse trabalhador — na app Ekipa, no seu próprio telemóvel.",
        },
      },
      disclosure:
        "Encontrou uma falha de segurança? Queremos ouvi-la, com discrição e rapidez:",
    },
    cta: {
      title: "A segurança é uma camada do motor.",
      description:
        "A mesma disciplina corre na aritmética da folha, nas declarações fiscais e nos livros.",
      engine: "Ver o motor",
    },
  },
  enginePage: {
    ...
    hero: {
      ...
      description:
        "O Xefe mantém os ecrãs simples porque a parte difícil vive no motor: a lei laboral, fiscal e de segurança social de Timor-Leste, implementada regra a regra e verificada contra a forma como a folha realmente se faz no país.",
    ...
    trace: {
      ...
      employerInss:
        "INSS do empregador (6%) — custo do empregador, não é dedução",
      thirteenth: "Provisão do 13.º mês, a pagar até 20 de dezembro",
      perMonth: "/mês",
      footCeiling:
        "Verificação do teto de deduções: $139.32 retidos ≤ $423.97 (30% do salário), dentro do limite do Art. 42(3).",
      footPrecision:
        "Todos os valores usam aritmética decimal exata — o motor nunca usa vírgula flutuante. Até o divisor da taxa horária é configurável: o padrão anualizado mostrado aqui, ou a convenção das 190 horas usada por muitos contabilistas timorenses.",
    },
    law: {
    ...
    proof: {
      ...
      description:
        "O software de folha costuma ser testado apenas contra as suas próprias suposições. O motor do Xefe é verificado contra três tipos independentes de evidência.",
      tierLabel: "Nível",
      tier1Name: "Lei primária",
      tier1:
        "Cada regra legal é implementada com testes de fronteira — mais de 600 testes automáticos em todo o produto, cerca de 176 só na aritmética de folha e impostos: limiares, meses de quatro e cinco semanas, trabalho noturno através da meia-noite, datas de compensação, o teto de deduções.",
      tier2Name: "Prática real",
      tier2:
        "O motor reproduz resultados de folha preparados por contabilistas em exercício em Timor-Leste — centenas de cálculos mensais reproduzidos ao cêntimo, incluindo convenções locais como o divisor salarial de 190 horas, que o Xefe oferece como configuração explícita.",
      tier3Name: "Avaliações oficiais",
      tier3:
        "Onde existem valores avaliados pela própria autoridade tributária, a aritmética do Xefe corresponde ao cêntimo — em categorias de retenção da renda à construção, para salários de residentes e não residentes. Num dos casos, a autoridade corrigiu uma declaração errada exatamente para o valor que o Xefe calcula por defeito.",
      ratesTitle: "Taxas de retenção que o motor aplica",
      ratesNote:
        "Ao abrigo da Lei 8/2008. As linhas avaliadas estão confirmadas contra a aritmética da própria autoridade tributária.",
    ...
    pipeline: {
      ...
      description:
        "O dono vê um assistente. O motor corre seis etapas — cada uma validada e recuperável.",
      steps: {
        compile: {
          title: "Compilar",
          description:
            "A assiduidade, os turnos e as licenças aprovadas entram na folha. As horas noturnas são detetadas automaticamente na janela 21:00–06:00, mesmo através da meia-noite. As licenças pagas compensam faltas e as admissões a meio do mês são calculadas proporcionalmente.",
        },
        guard: {
          title: "Proteger",
          description:
        ...
        post: {
          title: "Lançar",
          description:
            "Um lançamento contabilístico de dupla entrada, equilibrado, entra automaticamente num plano de contas TL com 77 contas — salários e INSS do empregador a débito, salário líquido e cada obrigação legal a crédito na sua própria conta. Um lançamento desequilibrado é recusado.",
        },
        deliver: {
          title: "Entregar",
          description:
            "Cada trabalhador recebe o recibo em PDF — em tétum, português ou inglês — com as contribuições do empregador, os totais do ano e o campo de assinatura. Quem usa a app Ekipa recebe uma notificação assim que está pronto.",
        },
        file: {
          title: "Declarar",
          description:
            "A Declaração de Remunerações do INSS no formato oficial e o formulário mensal consolidado da ATTL geram-se sozinhos, com os dados de pagamento preenchidos e os prazos ajustados ao dia útil seguinte em Timor-Leste.",
        },
        pay: {
          title: "Pagar",
          description:
            "Descarregue o pacote Excel BNU de duas folhas, baseado em evidência, com email de cobertura em português e ordem de pagamento assinada. Os formatos BNCTL, Mandiri e ANZ são marcados como melhor esforço até confirmação do banco. Quem usa QuickBooks pode exportar o lançamento em CSV ou IIF.",
        },
      },
    },
    trust: {
    ...
    cta: {
      ...
      description:
        "Configurar é grátis: adicione a equipa, construa uma folha de rascunho e inspecione cada número desta página nos seus próprios livros. Só subscreve quando finalizar uma folha real.",
      secondary: "Ver preços",
      footnote:
        "O trabalhador acima é ilustrativo — a aritmética é a do próprio motor.",
    },
  },
  publicDocs: {
  ...
  howItWorks: {
    ...
    hero: {
      ...
      proof: {
        ...
        people: {
          ...
          description:
            "Salário, tempo, licenças e dados de pagamento permanecem juntos.",
        },
        payroll: {
          title: "Folha calculada",
          description:
            "IRT, INSS, horas extra e subsídio anual permanecem visíveis.",
        },
        outputs: {
          title: "Pagamentos e declarações preparados",
          description:
            "Recibos, ficheiros bancários e mapas de conformidade saem do processamento.",
        },
        accounts: {
          title: "Lançamento equilibrado",
          description:
            "Despesas de folha e passivos entram na contabilidade de dupla entrada.",
        },
      },
    },
    audience: {
      ...
      description:
        "O Xefe mantém o percurso normal tranquilo sem esconder a evidência de que um contabilista precisa.",
      everyday: {
        title: "Para o trabalho diário da empresa",
        description:
          "Proprietários e equipas recebem tarefas guiadas, palavras claras e uma próxima ação de cada vez.",
        points: {
          guided:
      ...
      professional: {
        ...
        description:
          "O detalhe profissional fica disponível quando é preciso inspecionar, reconciliar ou declarar.",
        points: {
          calculations:
            "Bases de cálculo, taxas, classificações e arredondamentos visíveis",
          accounting:
            "Lançamentos equilibrados, razão geral, balancete e demonstrações",
          compliance:
            "Mapas de IRT, INSS e fiscalidade avançada com histórico de auditoria",
        },
      },
      modeTitle: "O detalhe avançado aparece apenas quando ajuda.",
      modeDescription:
        "Os contabilistas veem automaticamente os controlos fiscais especializados. Um proprietário pode ativar o mesmo modo quando o contabilista pedir; todos os outros mantêm o fluxo simples.",
    },
    workflow: {
    ...
    example: {
      ...
      description:
        "Os mesmos números devem fazer sentido para quem paga à equipa e para o contabilista que revê os livros.",
      ...
      journalNote:
        "Os totais do lançamento correspondem ao custo do empregador e mantêm separados os passivos de INSS do trabalhador e do empregador.",
      disclaimer:
        "Exemplo mensal sintético e ilustrativo para um trabalhador residente. As horas extra e o subsídio de alimentação aparecem fora da base de INSS. O tratamento real depende da configuração do trabalhador e da rubrica, da lei aplicável e de eventuais isenções.",
    },
    controls: {
      ...
      outputs: {
        payslips:
          "Recibos dos trabalhadores com rendimentos e deduções linha a linha",
        bankFiles:
          "Ficheiros de pagamento de folha para bancos suportados em Timor-Leste",
  ...
  settings: {
    ...
    access: {
      ...
      invitedDescription:
        "A pessoa pode usar o email de convite para aderir a esta empresa.",
      ...
      removeDescription:
        "{{email}} deixará de poder abrir esta empresa no Xefe.",
    },
    advancedTax: {
      title: "Modo fiscal avançado",
      description:
        "Mostra controlos fiscais de nível contabilista — retenção a fornecedores, taxas de tratado e formulários de declaração — a todos os que gerem esta empresa. Deixe desligado salvo indicação do seu contabilista; o Xefe aplica valores seguros por defeito.",
    ...
    structure: {
      ...
      workLocationsHint:
        "Adicione todos os seus escritórios e locais de trabalho",
      ...
      autoPopulateHint:
        "Selecione um sector acima para preencher automaticamente",
    ...
    payment: {
      ...
      description:
        "Configure métodos de pagamento, contas bancárias e períodos de pagamento",
      ...
      bankAccountsHint:
        "Adicione contas para pagamentos de folha, impostos e segurança social",
      ...
      bankDetailsError:
        "Preencha o banco e o número da conta, ou remova a conta vazia.",
      frequencyLabels: {
        hourly: "À Hora",
        daily: "Diária",
        weekly: "Semanal",
    ...
    timeOff: {
      ...
      customTypes: {
        ...
        code: "Código",
        codeTaken:
          "Este código já está a ser utilizado por outro tipo de licença.",
        requiresCertificate: "Requer documento comprovativo",
        add: "Adicionar tipo",
        addTitle: "Adicionar tipo de licença personalizado",
        saveReminder:
          "Os tipos novos e editados são guardados quando premir Guardar abaixo.",
      },
      breastfeedingNote:
      ...
      parentalPaidWarning:
        "O INSS não paga o subsídio nos dias em que o trabalhador recebe salário (DL 18/2017, art. 21.º(3)) — a maternidade/paternidade paga pelo empregador substitui o subsídio do INSS, não acresce a ele.",
      title: "Políticas de Licenças",
      description:
        "Configure direitos de licença com base na lei laboral de Timor-Leste",
      laborCodeTitle: "Código do Trabalho de Timor-Leste (Lei 4/2012)",
      laborCodeHint:
        "Os valores padrão estão definidos conforme a lei laboral de TL. Ajuste apenas se a sua empresa oferecer melhores benefícios.",
      probationLabel:
        "Período Experimental Antes da Elegibilidade para Licença",
      probationHint:
        "As férias anuais não podem começar antes de o funcionário completar estes meses (período experimental: Lei do Trabalho, art. 14.º). Proprietários e administradores de RH podem abrir exceção num pedido específico.",
      months: "meses",
      ...
      specialLeaveHint:
        "Uma única alocação de dias pagos por ano civil que cobre casamento, falecimento de familiar e eventos comunitários ou religiosos (Lei do Trabalho, art. 33.º, n.º 3). O empregador pode pedir comprovativo.",
      days: "dias",
      weeks: "semanas",
    ...
    payroll: {
      ...
      residentThresholdHint:
        "Primeiros ${{amount}} isentos de imposto para residentes (Lei Tributária 8/2008, Anexo V)",
      residentRate: "Taxa para Residentes",
      nonResidentRate: "Taxa para Não-Residentes",
      flatRateHint:
        "Taxa fixa desde o primeiro dólar (Lei Tributária 8/2008, Anexo V)",
      socialSecurity: "Segurança Social (INSS)",
      employeeContribution: "Contribuição do Funcionário",
      employeeContributionHint:
        "Taxa legal: 4% (Decreto-Lei 20/2017, arts. 8.º–10.º)",
      employerContribution: "Contribuição do Empregador",
      employerContributionHint:
        "Taxa legal: 6% (Decreto-Lei 20/2017, arts. 8.º–10.º)",
      excludeFoodAllowance: "Excluir subsídio de alimentação da SS",
      excludePerDiem: "Excluir per diem da SS",
      inssExclusionsHint:
        "Os subsídios de despesas ficam fora da base contributiva do INSS por lei (Decreto-Lei 20/2017, art. 9.º). Inclua um apenas se for realmente remuneração regular paga todos os meses.",
      overtime: "Horário de Trabalho e Horas Extra",
      maxHoursWeek: "Máximo Horas/Semana",
      maxHoursWeekHint:
        "Máximo legal: 44 horas/semana (Lei do Trabalho, art. 25.º)",
      ...
      hourlyRateHint:
        "O método de 190 horas arredonda a taxa horária para cima e o total combinado de horas extra uma vez. Use o método dos contratos ou da folha do contabilista.",
      first2HoursRate: "Taxa Normal de Horas Extra",
      first2HoursHint:
        "1,5× = +50%, o mínimo legal (Lei do Trabalho, art. 27.º)",
      beyond2HoursRate: "Taxa Além de 2h HE",
      beyond2HoursHint: "2x = +100%",
      sundayHolidayRate: "Taxa Domingo/Feriado",
      sundayHolidayHint:
        "2× = +100%, o mínimo legal para trabalho em dia de descanso e feriado (Lei do Trabalho, arts. 27.º/2 e 30.º)",
      nightPremiumRate: "Prémio de Horas Noturnas",
      nightPremiumHint:
        "Pagamento extra pelas horas trabalhadas entre as 21:00 e as 06:00. O mínimo legal é +25%.",
      minimumWageSection: "Salário Mínimo",
      minimumWageLabel: "Salário mínimo mensal",
      minimumWageHint:
        "O mínimo legal em Timor-Leste é $115/mês (inalterado desde 2012). A folha avisa quando um salário está abaixo deste valor.",
      thirteenthMonth: "Subsídio Anual (13.º Mês)",
      enable13th: "Ativar pagamento do 13.º mês",
      subsidioDeadlineNote:
        "Prazo legal: pagar até 20 de dezembro de cada ano (Lei do Trabalho, art. 44.º).",
      approvalSection: "Aprovação da folha de pagamento",
      selfApprovalLabel: "Permitir autoaprovação (operador único)",
      selfApprovalDesc:
        "Quem cria a folha de pagamento também pode aprová-la. Use apenas se a sua empresa tiver um único administrador de folha — desativado, um segundo administrador deve aprovar cada folha (mais seguro).",
      selfApprovalOwnerOnly:
        "Apenas o proprietário da conta pode alterar isto.",
      invalidValues:
        "Verifique taxas e horas. As percentagens devem ser 0–100.",
      ...
      statutory: {
        ...
        description:
          "O Xefe aplica estas regras legais automaticamente. São definidas por lei e não podem ser editadas.",
        pending: "Confirmação pendente",
        witDueLabel: "Imposto mensal sobre salários (IRT/WIT)",
        witDueValue:
          "Pagar até ao dia 15 do mês seguinte (Lei 8/2008, art. 23.º)",
  ...
  employees: {
    profile: {
      ...
      notFound:
        "N\u00e3o encontr\u00e1mos esse trabalhador. Pode ter sido removido.",
      backToEmployees: "Todos os trabalhadores",
      sectionPersonal: "Quem \u00e9",
      sectionJob: "O que faz e quanto lhe paga",
      appInvite: "Convite para a app",
      inviteSending: "A enviar\u2026",
      inviteSentTitle: "Convite enviado",
      inviteSentDesc:
        "{{email}} vai receber um e-mail para definir a palavra-passe e entrar no Ekipa.",
      inviteExistsTitle: "J\u00e1 tem acesso",
      inviteExistsDesc:
        "{{email}} j\u00e1 \u00e9 membro \u2014 pode entrar ou usar \u201cRecuperar palavra-passe\u201d.",
      ...
      convertedTitle: "Contrato convertido",
      convertedDesc:
        "O registo do trabalhador passou a permanente e a data de fim do contrato a termo foi limpa.",
      convertFailedTitle: "N\u00e3o foi poss\u00edvel converter o contrato",
      renewedTimes: "Renovado {{count}} vez(es)",
      leaveRemaining: "{{count}} por gozar",
      leaveUsed: "{{count}} gozados",
      leavePending: "{{count}} pendentes",
      noNationality: "Sem nacionalidade ainda",
      docSocialSecurity: "N\u00famero da Seguran\u00e7a Social",
      docTin: "NIF do trabalhador",
      docElectoral: "Cart\u00e3o eleitoral",
      docIdCard: "Bilhete de identidade",
      docPassport: "Passaporte",
      employmentDocuments: "Documentos de trabalho",
      documentUploaded: "Documento carregado",
      uploadedOn: "Carregado a {{date}}",
      uploadContract: "Carregar contrato",
      workingVisa: "Visto de trabalho / resid\u00eancia",
      uploadVisa: "Carregar documento do visto",
      addVisa: "Adicionar dados do visto",
      expired: "Expirou a {{date}}",
    ...
    templateDownloadedDesc:
      "Modelo CSV de funcionários descarregado com sucesso",
    ...
    importErrorDesc:
      "Falha ao analisar ficheiro CSV. Por favor verifique o formato.",
    ...
    empty: {
      ...
      connectionDesc:
        "Não foi possível carregar dados dos funcionários. Por favor verifique a sua conexão.",
      noEmployeesTitle: "Nenhum Funcionário Encontrado",
      noEmployeesSearch: "Nenhum funcionário corresponde à sua pesquisa.",
      noEmployeesStart:
        "Comece adicionando o seu primeiro funcionário ao sistema.",
    },
    pagination: {
    ...
    compliance: {
      ...
      blockingIssues:
        "A mostrar funcionários com problemas bloqueantes na folha",
    ...
    ekipaAccount: {
      ...
      confirmMessage:
        "Criar uma conta Ekipa para {{name}}? Um email de redefinição de palavra-passe será enviado para {{email}}.",
      creating: "A criar conta...",
      success:
        "Conta Ekipa criada para {{name}}. Email de redefinição de palavra-passe enviado.",
    ...
    directory: {
      ...
      searchLimitReached:
        "Os resultados da pesquisa podem estar incompletos. Tente um termo mais específico.",
      duplicatesFound:
        "{{count}} possível(eis) registo(s) duplicado(s) — o mesmo nome ou ID aparece mais de uma vez",
    },
    table: {
      employee: "Funcionário",
      department: "Departamento",
  ...
  departments: {
    ...
    emptyDesc:
      "Adicione funcionários à sua base de dados para ver informação de departamento",
    addFirstEmployee: "Adicionar Primeiro Funcionário",
    stats: {
    ...
    toast: {
      ...
      migratedDesc:
        "Criados automaticamente {{count}} departamentos a partir dos registos de funcionários existentes",
    },
  },
  orgChart: {
    title: "Organograma",
    ...
    toast: {
      connectionTitle: "Problema de Conexão",
      connectionOffline:
        "Não foi possível conectar à base de dados. A mostrar dados de demonstração.",
      loadFailed:
  ...
  addEmployee: {
    ...
    toast: {
      ...
      fixedTermMotiveDesc:
        "Art. 12.º(2): um contrato a termo sem motivo declarado é considerado permanente.",
      minorWarningTitle: "Trabalhador menor (Lei do Trabalho, art. 69.º)",
      minorWarningDesc:
        "Apenas trabalho leve: máx. 5h/dia, 25h/semana, sem trabalho noturno nem horas extraordinárias.",
      errorTitle: "Erro",
    ...
    fields: {
      ...
      contractEndDateHelp:
        "Apenas para contratos a termo — deixe vazio se for permanente.",
      ...
      partTimeWageHelp:
        "Para trabalhadores a tempo parcial, registe as horas contratadas e o tratamento salarial acordado após revisão. A folha não presumirá o mínimo de tempo inteiro.",
    ...
    contractGen: {
      ...
      description:
        "Escolha um modelo de contrato e preencha-o automaticamente com os dados deste funcionário, ou use o Preenchimento Rápido com IA.",
      ...
      aiFailedDesc:
        "Não foi possível preencher o modelo com IA. Tente novamente ou edite o texto manualmente.",
      ...
      noTemplates:
        "Ainda não há modelos de contrato disponíveis. Peça ao administrador da plataforma para carregar um.",
    ...
    documents: {
      ...
      foreignWorkerDesc:
        "Visto de trabalho e autorização SEFOPE são obrigatórios anualmente para trabalhadores estrangeiros",
      inssPlaceholder: "100XXXXXX",
      expiryWarning:
        "Alguns documentos estão expirados ou prestes a expirar. Por favor atualize-os.",
      status: {
        expired: "Expirado",
        valid: "Válido",
        days: "{{count}} dias",
  ...
  hiring: {
    createJob: {
      ...
      title: "Criar Vaga",
      subtitle:
        "Publicar um novo cargo com detalhes de contrato e período experimental",
      ...
      labels: {
        ...
        probationPeriod:
          "Período Experimental (Artigo 14 do Código do Trabalho)",
    ...
    candidates: {
      ...
      import: {
        ...
        description:
          "Carregar ficheiros de CV e carta de motivação. A nossa IA irá extrair automaticamente a informação do candidato.",
        ...
        processingDesc:
          "A extrair informação do candidato dos ficheiros carregados",
    ...
    onboarding: {
      ...
      preBoarding: {
        ...
        description:
          "Bem-vindo à equipa! Vamos começar o processo de integração.",
        welcome:
          "Bem-vindo ao Xefe! Estamos entusiasmados por tê-lo na nossa equipa. Este processo de integração irá ajudá-lo a familiarizar-se com as políticas, procedimentos e sistemas da empresa.",
        ...
        timeDescription:
          "O processo completo de integração demora tipicamente 2-3 horas distribuídas pela primeira semana.",
        start: "Iniciar Processo de Integração",
      },
      personal: {
        title: "Informação Pessoal e Legal",
        description:
          "Por favor forneça os seus dados pessoais e documentação legal.",
        fields: {
          fullName: "Nome Completo *",
      ...
      policies: {
        ...
        description:
          "Por favor reveja o manual da empresa e confirme a compreensão das nossas políticas.",
        handbook: {
          title: "Manual da Empresa",
          description:
            "Manual do funcionário com políticas, procedimentos e diretrizes da empresa",
        ...
        signaturePrompt:
          "Ao marcar a caixa abaixo, reconheço que li, compreendi e concordo em cumprir todas as políticas da empresa.",
      ...
      sops: {
        ...
        description:
          "Reveja e confirme a compreensão dos procedimentos específicos do departamento.",
        ...
        items: {
          ...
          deployment: {
            ...
            description:
              "Procedimentos passo a passo de implantação e reversão",
          },
          security: {
            title: "Melhores Práticas de Segurança",
            description:
              "Protocolos de segurança e diretrizes de tratamento de dados",
          },
        },
      ...
      itEquipment: {
        ...
        notice:
          "O suporte de TI irá contactá-lo dentro de 24 horas para agendar a recolha de equipamento e configuração de contas.",
      ...
      benefits: {
        ...
        notice:
          "Os formulários de inscrição em benefícios serão enviados para o seu email. Por favor complete dentro de 30 dias da data de início.",
      ...
      probation: {
        ...
        week2: "Semana 2",
        week2Milestone:
          "Completar todas as tarefas de integração e formação inicial",
        month1: "Mês 1",
        ...
        month3: "Mês 3",
        month3Milestone:
          "Avaliação final do período experimental e confirmação",
      ...
      feedback: {
        ...
        placeholder:
          "Partilhe os seus pensamentos sobre a experiência de integração até agora...",
        completeTitle: "Integração Completa!",
        completeDesc:
          "Completou todos os passos de integração. Bem-vindo à equipa!",
      },
    },
    offboarding: {
      art55: {
      ...
      exitInterviews: {
        ...
        description:
          "Respostas registadas durante a desvinculação, para saídas concluídas.",
        export: "Exportar CSV",
        exportedDesc:
          "Respostas das entrevistas de saída descarregadas como ficheiro CSV.",
      ...
      disciplinary: {
        noConcludedWarning:
          "Não existe qualquer processo disciplinar concluído em arquivo para este trabalhador. O despedimento com justa causa sem o processo escrito do art. 50.º(4) (acusação, defesa, decisão fundamentada) é automaticamente ilícito (art. 51.º) e expõe-no à indemnização do art. 55.º — confirme com o seu contabilista.",
      },
      certificate: {
        generate: "Gerar certificado (art. 57.º)",
        mandatoryNote:
          "O Certificado de Trabalho (nome, datas do contrato, funções desempenhadas) é obrigatório em qualquer cessação — art. 57.º.",
      },
      ...
      dialog: {
        ...
        description:
          "Iniciar o processo de desvinculação para um funcionário em saída",
      ...
      empty: {
        ...
        noEmployeesDesc:
          "Adicione funcionários à sua base de dados para gerir processos de desvinculação",
      },
      stats: {
        totalEmployees: "Total de Funcionários",
      ...
      ongoing: {
        ...
        description:
          "{{count}} funcionários atualmente em processo de desvinculação",
      ...
      checklist: {
        ...
        items: {
          ...
          inssCessationHint:
            "Declare no portal da Segurança Social até ao dia 10 do mês seguinte ao último dia de trabalho — enquanto não for declarada, a Segurança Social presume que o vínculo continua e as contribuições continuam a vencer.",
      ...
      finalPay: {
        ...
        reviewAcknowledgement:
          "Confirmo que um contabilista ou revisor jurídico verificou este tratamento.",
        deathHeirsNote:
          "Trabalhador falecido (art. 47.º(1)(b)): este pagamento é devido à herança/aos herdeiros — confirme os beneficiários com o seu contabilista.",
        title: "Compensação de serviço do Artigo 56.º",
        description:
          "Um mês de salário por cada período completo de cinco anos de serviço.",
        includeSeverance:
          "Pagar a compensação do Art. 56.º na folha de pagamento final",
        severanceOnNote:
          "Predefinição para este motivo de saída. A próxima folha de pagamento paga-a automaticamente quando o caso for concluído.",
        severanceOffNote:
          "Normalmente não é paga para este motivo de saída na prática timorense — mas o texto da lei não distingue a causa, pelo que o trabalhador pode ainda ter direito. Confirme com o seu contabilista.",
        severanceToggleFailed:
          "Não foi possível guardar a decisão sobre a compensação.",
        excludedTag: "(excluída — apenas referência)",
        saved: "Calculado",
        savedTitle: "Cálculo do Artigo 56.º guardado",
        savedDescription:
          "O salário de origem, as datas de serviço e o resultado legal ficaram registados neste caso.",
        ...
        subsidioNote:
          "Apenas referência — o próximo processamento salarial deste trabalhador paga automaticamente a indemnização + este 13.º mês proporcional (líquido do que já foi pago). Não liquide estes valores manualmente.",
        sourceHint:
          "Usa o salário mensal e a data de admissão guardados, mais o último dia de trabalho deste caso.",
        lastDay: "Último dia de trabalho",
        taxNote:
          "Sujeito a WIT nos termos do Art. 1.º da Lei Tributária. Este pagamento universal do Art. 56.º não integra a base do INSS. Guardar não processa nem paga a folha.",
  ...
  timeLeave: {
    timeTracking: {
      ...
      dialog: {
        ...
        tooLong:
          "Estas horas somam {{hours}}h — verifique a entrada e a saída.",
        cancel: "Cancelar",
      ...
      edit: {
        ...
        deleteDesc:
          "Isto remove o registo de assiduidade de {{name}} em {{date}}. Não pode ser anulado.",
    ...
    leaveRequests: {
      ...
      scopeMissing:
        "A sua conta de gestor ainda não está ligada a um departamento. Pode ver os seus próprios pedidos, mas os RH têm de definir o seu departamento antes de aparecerem as aprovações da equipa.",
      actions: {
      ...
      dialog: {
        ...
        miscarriageInssHint:
          "Após uma interrupção da gravidez, a trabalhadora tem direito a uma licença de 4 semanas (Lei do Trabalho, art. 59.º(4)). Por defeito, não é paga pelo empregador: a trabalhadora pede o subsídio parental diretamente ao INSS (no prazo de 6 meses a contar do primeiro dia da licença) quando tem 6 meses de contribuições nos últimos 12 (DL n.º 18/2017).",
        breastfeedingNote:
          "Depois de regressar, a trabalhadora tem direito a duas pausas diárias pagas de 1 hora até o bebé completar 6 meses (art. 62.º) — registe-as na assiduidade como tempo trabalhado, não as desconte.",
        maternityInssHint:
          "A trabalhadora pede o subsídio de maternidade diretamente ao INSS (no prazo de 6 meses a contar do primeiro dia da licença). O INSS paga 100% do salário de referência, mensalmente, até 90 dias, quando a trabalhadora tem 6 meses de contribuições nos últimos 12 (DL 18/2017). A licença em si é de, no mínimo, 12 semanas, das quais pelo menos 10 após o parto.",
        paternityInssHint:
          "O trabalhador pede o subsídio de paternidade diretamente ao INSS (no prazo de 6 meses a contar do primeiro dia da licença). O INSS paga 100% do salário de referência, num pagamento único, pelos 5 dias úteis, quando o trabalhador tem 6 meses de contribuições nos últimos 12 (DL 18/2017).",
        parentalInssFallbackHint:
          "Se o trabalhador não cumprir a condição de contribuições, o INSS não paga nada — se o empregador tem de pagar em substituição é juridicamente incerto; confirme com o seu contabilista.",
        ...
        reason: "Motivo *",
        reasonPlaceholder:
          "Por favor forneça um motivo para o pedido de licença...",
      ...
      overBalance: {
        ...
        description:
          "Como administrador, pode concedê-la mesmo assim — os dias extra ficam registados para o trabalhador.",
      ...
      reject: {
        ...
        description:
          "Tem a certeza que quer rejeitar o pedido de licença de {{name}}?",
      ...
      toast: {
        ...
        errorTitle: "Erro",
        loadFailed:
          "Falha ao carregar dados de licença. Por favor tente novamente.",
        validationTitle: "Erro de Validação",
        validationDesc: "Por favor preencha todos os campos obrigatórios.",
        ...
        submitFailed:
          "Falha ao submeter pedido de licença. Por favor tente novamente.",
        ...
        noEmailDesc:
          "{{name}} não tem email registado — adicione um ao perfil para receber emails de decisão.",
        emailFailedDesc:
          "A decisão foi guardada mas o email para {{name}} não pôde ser enviado.",
    ...
    attendance: {
      ...
      import: {
        ...
        description:
          "Importar registos de assiduidade de dispositivo biométrico ou ficheiro CSV",
        selectFile: "Selecionar Ficheiro",
        format:
          "CSV ou XLSX — qualquer formato serve; o XefeBot lê ficheiros desorganizados",
        importing: "A importar...",
        skippedSummary:
          "{{count}} de {{total}} linhas foram ignoradas e não importadas",
        rowLabel: "Linha",
      ...
      empty: {
        ...
        instructions:
          "Use os botões acima para marcar assiduidade manualmente ou importe registos do seu dispositivo biométrico.",
      ...
      toast: {
        ...
        importAiDesc:
          "O formato não correspondia, por isso o XefeBot normalizou-o — {{count}} registo(s) reconhecido(s).",
    ...
    shiftScheduling: {
      ...
      scopeMissing:
        "A sua conta de gestor ainda não está ligada a um departamento. Os RH têm de definir o seu departamento antes de poder gerir os turnos da equipa.",
      controls: {
      ...
      grid: {
        ...
        emptyHint:
          'Clique em "Todos os funcionários" para ver toda a gente, ou clique numa célula vazia para criar um turno',
        allStaff: "Todos os funcionários",
        scheduledOnly: "Apenas escalados",
        dragHint:
          "Arraste turnos para reatribuir · Clique numa célula vazia para criar",
      },
      locationView: {
        ...
        noSlotsHint:
          "Clique no ícone de definições no cartão do local para configurar os horários de turno",
      ...
      noLocations: {
        ...
        dialogHint:
          "Dica: adicione locais de trabalho em Definições → Estrutura para atribuir turnos a um local.",
      },
      create: {
        title: "Criar Turno",
      ...
      delete: {
        ...
        description:
          "Tem a certeza que quer eliminar este turno? Esta ação não pode ser revertida.",
        confirm: "Eliminar",
      },
      status: {
        draft: "Rascunho",
      ...
      employees: {
        ...
        description:
          "Ver escalas dos funcionários e acompanhamento de horas semanais",
        department: "Departamento:",
        email: "Email:",
        phone: "Telefone:",
      ...
      recommendations: {
        ...
        overworkedDesc:
          "Escalado para {{hours}}h, excede o máximo de {{max}}h em {{excess}}h.",
      },
      toast: {
        validationTitle: "Erro de Validação",
        validationDesc: "Por favor preencha todos os campos obrigatórios.",
        ...
        restDesc:
          "Os funcionários precisam de pelo menos 12 horas entre turnos.",
        leaveConflictDesc:
          "Este funcionário tem uma licença aprovada nessa data.",
        successTitle: "Sucesso",
        errorTitle: "Erro",
        ...
        copiedDesc:
          "{{count}} turnos copiados para a próxima semana como rascunhos.",
        copiedWithSkippedDesc:
          "{{count}} turnos copiados para a próxima semana como rascunhos. {{skipped}} ignorados (já agendados ou de licença).",
        copyAllSkippedTitle: "Já está atualizado",
        copyAllSkippedDesc:
          "A próxima semana já corresponde — {{skipped}} turnos ignorados (já agendados ou de licença).",
  ...
  reports: {
    payrollRun: {
      subtitle:
        "Resumo do que foi efetivamente pago em cada processamento de salários.",
      ...
      noRuns: {
        ...
        description:
          "Processe o primeiro salário para ver resumos pagos e detalhe por funcionário aqui.",
      ...
      duplicatesWarning:
        "{{count}} funcionário(s) aparecem mais de uma vez neste processamento — os totais podem contá-los em dobro. Reveja registos duplicados.",
    ...
    dashboard: {
      ...
      ngo: {
        ...
        allocationDesc:
          "Dividir totais da folha por código de projeto e fonte de financiamento.",
        donorExportTitle: "Pacote de Exportação para Doadores",
        donorExportDesc:
          "Exportar resumo da folha e linhas contabilísticas prontos para doadores.",
      },
      ...
      scheduledReportsDesc:
        "Relatórios que são executados automaticamente num horário",
      manage: "Gerir",
      noScheduledReports:
        "Sem relatórios agendados ainda. Configure relatórios automáticos em Relatórios Personalizados.",
    ...
    attendance: {
      ...
      cards: {
        summary: {
          ...
          description:
            "Registos diários de assiduidade para o período selecionado",
      ...
      recent: {
        ...
        emptyTitle:
          "Não foram encontrados registos de assiduidade para este período",
        emptyDescription:
          "Os registos aparecerão aqui assim que os funcionários fizerem entrada ou saída",
      },
    },
    shared: {
      periodLabel: "Período",
      ...
      unavailableDescription:
        "Este relatório não está disponível para a sua função atual.",
      monthsShort: "meses",
    },
    setup: {
      ...
      missing: {
        ...
        managerDescription:
          "Conclua a configuração breve da empresa antes de usar este relatório.",
        viewerDescription:
          "Um administrador precisa concluir a configuração da empresa antes de este relatório ficar disponível.",
      ...
      usersTable: {
        ...
        showingLimited:
          "A mostrar {{shown}} de {{total}} utilizadores. Exporte para ver todos.",
        columns: {
          user: "Utilizador",
          email: "Email",
          role: "Função",
      ...
      auditTable: {
        ...
        emptyDescription:
          "A atividade aparecerá aqui à medida que ações forem realizadas",
        showingLimited:
          "A mostrar {{shown}} de {{total}} entradas. Exporte para ver todas.",
        columns: {
          time: "Hora",
          action: "Ação",
          actor: "Autor",
    ...
    custom: {
      builtIn: "Predefinido",
      deleteDescription:
        "Isto remove o relatório guardado para todas as pessoas da sua empresa. Não elimina dados de funcionários nem registos de presença.",
      ...
      noDataDescription:
        "Peça a um administrador acesso a Pessoas ou Tempo e Licenças para criar um relatório personalizado.",
      buildReport: "Criar relatório",
      templatesTitle: "Modelos",
      templatesDescription:
        "Comece com um relatório pronto ou crie um para esta sessão.",
      ...
      showingLimited:
        "A mostrar 20 de {{count}} registos. Exporte para ver todos.",
      builder: {
        ...
        description:
          "Escolha a fonte de dados, as colunas necessárias e filtros opcionais.",
      ...
      toast: {
        ...
        validationDescription:
          "Introduza um nome e selecione pelo menos uma coluna.",
    ...
    employee: {
      ...
      cards: {
        ...
        newHires: {
          ...
          description:
            "Funcionários contratados recentemente no período selecionado",
    ...
    department: {
      ...
      cards: {
        overview: {
          ...
          description:
            "Lista completa de departamentos com total de funcionários",
          departments: "Departamentos",
    ...
    payroll: {
      ...
      empty: {
        ...
        description:
          "Adicione funcionários com informação salarial para gerar relatórios da folha",
      ...
      filters: {
        ...
        dialog: {
          ...
          description:
            "Filtrar funcionários por departamento, benefícios ou estado",
          department: "Departamento",
          allDepartments: "Todos os Departamentos",
          benefits: "Pacote de Benefícios",
      ...
      salaryDetail: {
        ...
        description:
          "Detalhe completo dos salários com cálculos fiscais de Timor-Leste",
        highest: "Mais Alto",
        lowest: "Mais Baixo",
        average: "Média",
        ...
        taxNoteDescription:
          "IRPS = (Bruto - $500) x 10% se o bruto for superior a $500 | INSS funcionário = 4% | INSS empregador = 6% (não mostrado)",
      },
      departmentDetail: {
    ...
    inssMonthly: {
      ...
      subtitle:
        "Gerar e acompanhar as submissões mensais de contribuições do INSS.",
      due: {
        arrearsNotice:
          "O pagamento em atraso vence juros de 1% por mês ou fração (DL 20/2017, art. 39.º).",
        arrearsEstimate:
          "Estimativa até agora para {{period}}: US$ {{amount}} ({{months}} × 1%).",
        overdueTitle: "{{task}} em atraso",
        overdueDescription:
          "{{task}} de {{period}} devia ser entregue em {{dueDate}}.",
        upcomingTitle: "{{task}} com prazo próximo",
        upcomingDescription:
          "{{task}} de {{period}} vence em {{dueDate}} ({{days}} dias).",
      },
      generate: {
        title: "Gerar Declaração Mensal do INSS",
        description:
          "Criar um resumo mensal de contribuições a partir das folhas já pagas.",
        year: "Ano",
      ...
      tracker: {
        ...
        actions: "Ações",
        empty:
          "Ainda não existem entregas do INSS. Gere a primeira declaração acima.",
      },
      actions: {
        export: "Exportar CSV",
      ...
      markFiled: {
        ...
        description:
          "Registar os detalhes da submissão de {{task}} para esta declaração do INSS.",
      ...
      toast: {
        ...
        generatedDescription:
          "A declaração mensal do INSS para {{period}} foi gerada.",
        generateErrorTitle: "Erro",
        generateErrorDescription:
          "Falha ao gerar a declaração do INSS. Confirme que existe folha paga para este período.",
        noDataTitle: "Sem dados disponíveis",
        noDataDescription:
          "Não foram encontrados dados de folha para {{period}}. Execute a folha primeiro e depois gere a declaração.",
        exportedTitle: "Exportado",
        exportedDescription: "Declaração do INSS exportada para CSV.",
        drExportedDescription:
          "Excel DR do INSS transferido — as colunas correspondem ao modelo oficial do portal.",
    ...
    inssAnnual: {
      ...
      subtitle:
        "Agregar contribuições mensais do INSS num resumo anual para o fecho do ano.",
      generate: {
        title: "Gerar Resumo Anual",
        description:
          "Agrega todas as declarações mensais do INSS do ano selecionado em totais anuais por funcionário.",
        year: "Ano",
        selectYear: "Selecionar ano",
      ...
      summary: {
        ...
        description:
          "Empregador: {{employer}} | NIF: {{tin}} | Meses entregues: {{monthsFiled}}/12",
        warning:
          "Apenas {{monthsFiled}} de 12 meses foram entregues. Gere as declarações mensais em falta antes de submeter a reconciliação anual.",
      },
      stats: {
        employees: "Funcionários",
      ...
      toast: {
        noDataTitle: "Sem Dados",
        noDataDescription:
          "Não foram encontradas declarações mensais do INSS para {{year}}. Gere primeiro as declarações mensais.",
        generatedTitle: "Resumo Anual Gerado",
        generatedDescription:
          "Foram agregados {{count}} meses de dados do INSS para {{year}}.",
        exportedTitle: "Exportado",
        exportedDescription:
          "Reconciliação anual do INSS para {{year}} exportada para CSV.",
      },
      csv: {
        employeeId: "ID Funcionário",
        fullName: "Nome Completo",
    ...
    donorExportPack: {
      ...
      subtitle:
        "Exportar dados contabilísticos da folha prontos para doadores diretamente a partir dos lançamentos contabilísticos registados.",
      exportButton: "Exportar Pacote (2 CSV)",
      exportHint:
        "Isto descarrega dois ficheiros: um resumo por projeto e as linhas detalhadas do diário.",
      filters: {
      ...
      summary: {
        ...
        empty:
          "Não foram encontradas linhas do diário da folha para este período.",
        project: "Projeto",
        fundingSource: "Fonte de Financiamento",
        salary: "Salário",
        inssEmployer: "INSS Empregador",
      ...
      toast: {
        ...
        description:
          "Os dois ficheiros de exportação para doadores foram descarregados.",
      },
      csv: {
        projectCode: "Código do Projeto",
        fundingSource: "Fonte de Financiamento",
    ...
    payrollAllocation: {
      ...
      subtitle:
        "Distribuição da folha por projeto e fonte de financiamento para relatórios de ONG e doadores.",
      ...
      table: {
        ...
        empty:
          "Não foram encontrados processamentos da folha aprovados ou pagos para este período.",
    ...
    attlMonthlyWit: {
      ...
      subtitle:
        "Declarações de Imposto sobre o Rendimento do Trabalho para a Autoridade Tributária de Timor-Leste (ATTL).",
      actions: {
      ...
      etax: {
        ...
        description:
          "A declaração mensal do imposto sobre salários pede apenas estes dois totais. Copie-os para o portal e-Tax e submeta lá — o Xefe nunca submete por si.",
        residentAccount:
          "Imposto Mensal sobre Rendimentos do Trabalho — Residentes",
        nonResidentAccount:
          "Imposto Mensal sobre Rendimentos do Trabalho — Não Residentes",
      ...
      payment: {
        ...
        description:
          'Entregue três cópias do Formulário de Impostos Mensais com o pagamento numa agência BNU, ou pague por transferência bancária marcada "pagamento eletrónico". O prazo é o dia 15 do mês seguinte.',
      ...
      alerts: {
        ...
        overdueDescription:
          "A declaração de IRT de {{period}} devia ter sido entregue em {{dueDate}}. Entregue-a imediatamente para evitar penalizações.",
        paymentOverdueDescription:
          "O pagamento de IRT de {{period}} venceu em {{dueDate}}. Registe o comprovativo assim que for pago.",
        upcomingTitle: "Prazo próximo",
        upcomingDescription:
          "A declaração de IRT de {{period}} vence em {{dueDate}} (faltam {{days}} dias).",
        paymentUpcomingDescription:
          "O pagamento de IRT de {{period}} vence em {{dueDate}} (faltam {{days}} dias).",
      },
      generate: {
      ...
      preview: {
        ...
        totalEmployees: "Total de Funcionários",
        employeeBreakdown:
          "{{residents}} residentes, {{nonResidents}} não residentes",
      ...
      history: {
        ...
        actions: "Ações",
        empty:
          "Ainda não existem entregas. Gere a sua primeira declaração de IRT acima.",
      },
      instructions: {
        ...
        step4:
          "4. Submeta através do portal e-Tax ou entregue 3 cópias no banco BNU.",
        step5:
          "5. Marque a declaração como entregue e guarde o número do recibo para os seus registos.",
        templateWarning:
      ...
      markFiled: {
        ...
        description:
          "Registar os detalhes da submissão desta declaração de IRT.",
        paymentTitle: "Registar Pagamento de IRT",
        paymentDescription:
          "Registe o comprovativo e liquide o IRT a pagar na contabilidade.",
        submissionMethod: "Método de Submissão",
        selectMethod: "Selecionar método",
        etax: "Portal e-Tax",
        bnu: "Banco BNU (papel)",
      ...
      toast: {
        ...
        csvExportedDescription:
          "Declaração de IRT exportada para CSV para envio no e-Tax.",
        tinRequiredTitle: "NIF da Empresa Obrigatório",
        tinRequiredDescription:
          "Atualize o NIF da empresa em Settings antes de gerar documentos fiscais.",
        pdfExportedTitle: "PDF Exportado",
        pdfExportedDescription:
          "Declaração de IRT exportada em PDF para registo.",
        ...
        officialTinRequiredDescription:
          "Atualize o NIF da empresa em Settings antes de gerar formulários oficiais ATTL.",
        ...
        paymentDescription:
          "A obrigação de IRT e o comprovativo de pagamento foram registados.",
        updateErrorDescription: "Falha ao atualizar o estado da entrega.",
      },
      csv: {
        employeeId: "ID Funcionário",
    ...
    etaxFiling: {
      ...
      copy: "Copiar valor",
      copyFailed:
        "Não foi possível copiar. Selecione e copie o valor manualmente.",
    ...
    dashboard: {
      ...
      sections: {
        staff: {
          title: "Pessoal",
          description:
            "Diretório de funcionários, departamentos, organograma, anúncios e reclamações.",
        },
        hiring: {
          title: "Recrutamento",
          description:
            "Vagas, candidatos, entrevistas, onboarding e offboarding.",
        },
        performance: {
          title: "Desempenho",
          description:
            "Objetivos, avaliações de desempenho, formação, certificações e ações disciplinares.",
        },
      },
    },
  },
  ...
  payroll: {
    dashboard: {
      ...
      subtitle:
        "Processar folha de pagamento, gerir pagamentos e gerar relatórios",
    },
    quickbooks: {
      export: {
        title: "Exportar para QuickBooks",
        description:
          "Gerar um ficheiro de lançamento contabilístico para importar no QuickBooks",
        payroll: "Folha de Pagamento",
        ...
        iifDesc:
          "Para QuickBooks Desktop - importar via Ficheiro > Utilitários",
        options: "Opções",
        ...
        errorDesc:
          "Não foi possível gerar o ficheiro de exportação. Por favor tente novamente.",
      },
      settings: {
        title: "Definições de Exportação QuickBooks",
        description:
          "Configurar mapeamentos de contas para integração QuickBooks",
        defaultFormat: "Formato de Exportação Padrão",
        accountMappings: "Mapeamentos de Contas",
        accountMappingsDesc:
          "Mapear contas da folha do Xefe para o seu plano de contas do QuickBooks",
        expenses: "Despesas",
        ...
        readyMappings:
          "A exportação do QuickBooks está pronta com {{count}} mapeamentos de contas.",
  ...
  setupWizard: {
    ...
    bankNameAccountRequired:
      "Nome do banco e número da conta são obrigatórios.",
    error: "Erro",
    ...
    loadFailedDesc:
      "Verifique a ligação e tente novamente. As definições existentes não foram alteradas.",
    stepAlreadySaved: "Este passo já está guardado",
    stepAlreadySavedDesc:
      "Continue para o próximo passo por concluir. Altere os dados guardados mais tarde nas Definições.",
    ...
    bankTransfer: "Transferência bancária",
    cashInfo:
      "Não são necessários dados bancários. Pode adicionar uma conta mais tarde se o processo mudar.",
    bankName: "Nome do Banco *",
  ...
  accounting: {
    chartOfAccounts: {
      ...
      subtitle:
        "Configure as categorias de conta usadas pelo Xefe para folha, faturas e relatórios (Plano de Contas).",
      ...
      warning:
        "Alterar contas afeta relatórios financeiros e cálculos da folha. Modifique apenas se compreender o impacto.",
      accountCode: "Código da Conta *",
      ...
      noAccountsDescription:
        "O Xefe pode adicionar uma lista de contas padrão de Timor-Leste para começar sem trabalho de configuração contabilística.",
    ...
    journalEntries: {
      ...
      subtitle:
        "Lançamentos Contábeis - Rever lançamentos contabilísticos da folha e operações",
      ...
      noEntriesDesc:
        "Os lançamentos são tipicamente gerados a partir de processamentos de folha",
    ...
    fixedAssets: {
      title: "Ativos Fixos",
      subtitle:
        "O registo de ativos: mapas de depreciação, registo mensal, abates",
      export: "Exportar registo",
      postDepreciation: "Registar depreciação",
      addAsset: "Adicionar ativo",
      addDescription:
        "O Xefe deprecia em linha reta a partir do mês de aquisição e regista um lançamento por mês.",
      empty:
        "Ainda não há ativos. Adicione o primeiro — a máquina de café conta.",
      ...
      deleteDescription:
        '"{{name}}" não tem depreciação registada, por isso pode ser removido.',
      ...
      schedule: "Mapa",
      scheduleDescription:
        "Linha reta durante {{life}} meses; as linhas a cinzento já foram registadas.",
      dispose: "Abater",
      disposeTitle: "Abater {{name}}",
      disposeDescription:
        "Remove o ativo dos livros e regista automaticamente o ganho ou a perda.",
      ...
      disposePreviewGain:
        "Valor líquido {{nbv}} — esta venda regista um ganho de {{amount}}.",
      disposePreviewLoss:
        "Valor líquido {{nbv}} — esta venda regista uma perda de {{amount}}.",
      ...
      acquisitionOriginHelp: {
        already_posted_via_bill:
          "Apenas registar. A fatura do fornecedor já lançou o custo do ativo.",
        opening_balance:
          "Apenas registar. O ativo já está incluído nos saldos de abertura.",
        post_now:
          "O Xefe debitará a conta do ativo e creditará a conta de financiamento uma única vez.",
      },
      fieldFundingAccount: "Pago por / devido a",
      fundingAccountPlaceholder:
        "Selecione caixa, banco, conta a pagar ou capital",
      fieldAcquired: "Data de aquisição",
      fieldCost: "Custo (USD)",
      fieldResidual: "Valor residual",
      fieldLife: "Vida útil (meses)",
      fieldLifeHint:
        "Pré-preenchido pela classe; ajuste por ativo. Terrenos nunca depreciam.",
      lifeRequired:
        "Indique a vida útil em meses — sem ela este ativo nunca seria depreciado.",
      ...
      postDescription:
        "Um lançamento agregado (Db 5800 / Cr 1590) cobrindo todos os ativos devidos, recuperação incluída.",
      postNothing: "Nada a depreciar neste período.",
      postHint:
        "Um período registado não pode ser registado duas vezes. Para corrigir, reverta o lançamento e ajuste os ativos.",
    ...
    recurring: {
      ...
      description:
        "Lançamentos que o Xefe regista por si todos os meses — acréscimos de renda, amortizações, ajustes fixos.",
      empty:
        'Ainda não há lançamentos recorrentes. Abra um lançamento registado e escolha "Tornar recorrente".',
      paused: "Em pausa",
      ...
      activeToggle: "Ativo",
      loadError:
        "Não foi possível carregar os lançamentos recorrentes. Tente novamente.",
      saveError:
        "Não foi possível guardar o lançamento recorrente. Tente novamente.",
      deletedTitle: "Lançamento recorrente eliminado",
      deleteTitle: "Eliminar lançamento recorrente?",
      deleteDescription:
        '"{{name}}" deixará de ser registado. Os lançamentos já registados permanecem no diário.',
      makeRecurringTitle: "Tornar este lançamento recorrente",
      makeRecurringDescription:
        "O Xefe registará uma cópia de {{ref}} todos os meses, no dia que escolher.",
      ...
      createdDescription:
        '"{{name}}" será registado automaticamente todos os meses.',
    },
    generalLedger: {
      title: "Razão Geral",
      ...
      selectAccountDesc:
        "Escolha uma conta acima para ver o histórico de transações",
    },
    trialBalance: {
      title: "Balancete",
      ...
      noReportDesc:
        "Selecione uma data e clique Gerar para criar o relatório do balancete",
    },
    incomeStatement: {
      ...
      noReportDesc:
        "Selecione um intervalo de datas e clique Gerar para criar a demonstração de resultados",
    ...
    balanceSheet: {
      ...
      notBalancedDesc:
        "Ativos não igualam Passivos + Capital Próprio. Verifique lançamentos em falta.",
      noReport: "Nenhum Balanço Patrimonial Gerado",
      noReportDesc:
        "Selecione uma data e clique Gerar para criar o balanço patrimonial",
    ...
    fiscalPeriods: {
      ...
      noYearDesc:
        "Crie um ano fiscal para gerir encerramentos de períodos e prevenir lançamentos retroativos.",
      ...
      periodsDesc:
        "Encerre períodos para prevenir novos lançamentos contabilísticos nesse mês.",
      month: "Mês",
      ...
      confirmCloseDesc:
        "Encerrar {{month}} {{year}} irá prevenir novos lançamentos. Pode reabrir mais tarde se necessário.",
      confirmReopen: "Reabrir este período?",
      confirmReopenDesc:
        "Reabrir {{month}} {{year}} permitirá novos lançamentos neste período.",
      confirmLock: "Bloquear este período?",
      confirmLockDesc:
        "Bloquear {{month}} {{year}} é permanente. Não poderá reabrir e não serão permitidos novos lançamentos neste período.",
      periodClosed: "Período Encerrado",
      periodClosedDesc:
        "Não podem ser publicados novos lançamentos neste período",
      periodReopened: "Período Reaberto",
      periodReopenedDesc:
        "Lançamentos podem ser publicados novamente neste período",
      ...
      obNotPostedDesc:
        "Introduza os saldos de abertura das contas do balanço para iniciar o ano fiscal.",
      enterOpeningBalances: "Introduzir Saldos de Abertura",
      obDialogDesc:
        "Introduza valores a débito ou crédito para cada conta do balanço. Os totais devem equilibrar (débito = crédito).",
      obCode: "Código",
      obAccount: "Conta",
      obType: "Tipo",
      ...
      obPostedDesc:
        "Os saldos de abertura para {{year}} foram publicados como lançamento contabilístico.",
    ...
    auditTrail: {
      ...
      filtersDesc:
        "Filtrar por ação, severidade, intervalo de datas ou pesquisa",
      search: "Pesquisar",
      ...
      dateRange: "Intervalo de Datas",
      loadError:
        "Falha ao carregar entradas de auditoria. Pode não ter permissão.",
    ...
    dashboard: {
      ...
      ngoReportingDesc:
        "Acesso direto a relatórios de alocação e exportação para doadores.",
      payrollAllocation: "Relatório de Alocação da Folha",
      payrollAllocationDesc:
        "Divisão por projeto e financiamento de lançamentos de folha e contabilidade",
      donorExport: "Pacote de Exportação para Doadores",
      donorExportDesc:
        "Exportar CSVs de resumo de folha e linhas contabilísticas prontos para doadores",
      ...
      accountantGateDesc:
        "Para tarefas diárias como enviar faturas, pagar contas ou processar folha, use",
      moneyLink: "Dinheiro",
      payrollLink: "Folha de Pagamento",
      accountantGateInstead: "em vez disso.",
      accountantGateNote:
        "A maioria das empresas nunca precisa de alterar nada aqui — o Xefe mantém isto sincronizado automaticamente.",
      accountantGateEnableHint:
        "Os proprietários podem ativar estes ecrãs em Definições → Modo fiscal avançado.",
      thisMonth: "Este Mês",
      ...
      payrollAutoPost:
        "A folha lança automaticamente os lançamentos contabilísticos. Estes não devem normalmente ser editados.",
      debit: "Débito",
      credit: "Crédito",
      viewAllPayrollEntries: "Ver todos os lançamentos da folha",
      attentionRequired: "Atenção Necessária",
      manualEntriesAwaiting:
        "{{count}} lançamentos manuais a aguardar aprovação",
      manualEntriesHint:
        "Lançamentos manuais podem afetar relatórios financeiros",
      review: "Rever",
  ...
  admin: {
    ...
    createTenant: {
      ...
      tenantDetailsDesc:
        "Introduza a informação básica para a nova organização",
    ...
    foreignWorkers: {
      ...
      subtitle:
        "Acompanhar autorizações de trabalho, vistos e documentação de conformidade",
      pageDesc:
        "Gerir documentação e acompanhamento de autorizações de trabalhadores estrangeiros",
      allEmployees: "Todos os Funcionários",
      actionRequired: "Ação Necessária",
      actionRequiredDesc:
        "{{expired}} trabalhador(es) têm documentos expirados. {{expiring}} trabalhador(es) têm documentos a expirar dentro de 30 dias.",
    ...
    userList: {
      ...
      dialog: {
        ...
        grantDescription:
          "Está prestes a conceder acesso de superadmin a {{email}}. Isto dá acesso total a todos os inquilinos e à gestão da plataforma.",
        revokeDescription:
          "Está prestes a revogar o acesso de superadmin de {{email}}. Esta pessoa deixará de conseguir aceder à consola de administração ou gerir outros inquilinos.",
      },
  ...
  money: {
    dashboard: {
      ...
      subtitle:
        "Acompanhe quem lhe deve, o que precisa pagar e o que fazer a seguir",
    ...
    customers: {
      ...
      tooltipContent:
        "Pessoas ou empresas a quem fatura bens ou serviços. Os registos de clientes guardam informação de contacto e estão ligados a faturas.",
    },
    invoices: {
      title: "Faturas",
      ...
      newCustomerDesc:
        "Introduza os dados do cliente. Pode completar mais tarde.",
      addCustomer: "Adicionar cliente",
      ...
      resetLinkDescription:
        "O link atual deixará de funcionar imediatamente e será criado um novo. Use isto se o link foi partilhado com a pessoa errada.",
    ...
    payments: {
      ...
      tooltipContent:
        "Registo de todos os pagamentos recebidos de clientes. Cada pagamento está ligado a uma fatura e atualiza o saldo dessa fatura.",
    ...
    settings: {
      ...
      bankDetailsDesc:
        "Informação de pagamento mostrada nas faturas para transferências bancárias",
      bankName: "Nome do Banco",
      ...
      tooltipContent:
        "Configure os detalhes da sua empresa, logótipo, taxa de imposto padrão, termos de pagamento e informação bancária que aparece em todas as faturas.",
      ...
      invoiceTemplateDesc:
        "O aspeto das suas faturas no ecrã, em PDF e por email",
      paymentAccounts: "Contas de Pagamento",
      paymentAccountsDesc:
        "Contas bancárias onde os clientes podem pagar — escolha uma por fatura",
      noAccounts:
        "Ainda sem contas de pagamento. Adicione uma para os clientes saberem onde pagar.",
      addAccount: "Adicionar Conta",
      accountLabel: "Nome",
      ...
      defaultMethodsHint:
        "Pré-selecionados em novas faturas; pode alterar por fatura.",
      footerMessage: "Mensagem de Rodapé",
      footerPlaceholder: "Obrigado pela sua preferência!",
      footerHelp:
        'Linha final no fundo das faturas, PDFs e emails — ex., "Obrigado por escolher a Onit Enterprises Lda."',
      bin: "BIN",
    ...
    recurring: {
      ...
      tooltipContent:
        "Modelos que geram novas faturas automaticamente num horário. Ideal para serviços de subscrição, retenções ou ciclos de faturação regulares.",
      ...
      confirmDeleteMsg:
        "Eliminar fatura recorrente para {{name}}? Isto não pode ser revertido.",
    ...
    recurringInvoiceForm: {
      ...
      customerScheduleDesc:
        "Selecione o cliente e defina a frequência de faturação",
      customer: "Cliente",
      selectCustomer: "Selecionar um cliente",
    ...
    vendors: {
      ...
      supplierTaxHelp:
        "Necessário apenas quando uma conta pode estar sujeita a retenção na fonte do fornecedor.",
    ...
    expenses: {
      ...
      dropStrip:
        "Arraste um recibo para aqui (PDF ou foto) — o XefeBot preenche os detalhes",
    ...
    allowances: {
      ...
      loadError:
        "Falha ao carregar dados de subsídios. Por favor atualize a página.",
      types: {
        transport: "Transporte",
    ...
    bills: {
      ...
      attachmentUploadError:
        "Falha ao carregar o anexo. A conta não foi guardada.",
      invalidFiles: "Alguns ficheiros foram ignorados",
      dropzoneHint:
        "Arraste e largue ficheiros da conta aqui, ou clique para procurar",
      dropzoneFormats: "PDF ou foto, até 10MB cada",
      dropStrip:
        "Arraste uma fatura para aqui (PDF ou foto) — o XefeBot preenche os detalhes",
      ...
      vendorTaxProfileRequired:
        "Adicione a residência fiscal e o regime fiscal deste fornecedor antes de guardar.",
      petroleumUnsupported:
        "A retenção do regime petrolífero não é suportada pelo calculador nacional.",
      payerWithholds: "A sua empresa retém o imposto no momento do pagamento.",
      supplierSelfWithholds:
        "O fornecedor é responsável pelo imposto; não reduza o pagamento.",
    ...
    profitLoss: {
      ...
      tooltipContent:
        "Também chamada Demonstração de Resultados. Mostra receita (dinheiro ganho com faturas) menos despesas (custos) para calcular lucro ou perda líquida para um período.",
    },
    balanceSheet: {
      title: "Balanço",
    ...
    bankRecon: {
      ...
      confirmReceiptEmail:
        "Se o cliente tiver um email registado, receberá um recibo de pagamento.",
      confirmRemainsDue: "continuará em dívida.",
      linkOnlyHint:
        "Já registado — a conciliação apenas associa esta linha bancária",
      ...
      settleBlocked:
        "O montante bancário é superior ao saldo em dívida — registe este pagamento a partir da página da fatura ou da conta.",
      unmatchLocked:
        "Pagamento registado — faça a gestão a partir da página da fatura ou da conta",
  ...
  runPayroll: {
    ...
    payDateNonWorkingDay:
      "Esta data de pagamento cai num fim de semana ou feriado. Art. 40.º(5): pague no dia útil anterior.",
    payDateUseDate: "Usar {date}",
    warningOTCapArt27:
      "excedeu o limite de horas extraordinárias do art. 27.º(4) (4h/dia / 16h/semana) neste período — só permitido em caso de força maior (art. 27.º(5))",
    warningRestDayCapArt27:
      "trabalhou mais de 8h num dia de descanso ou feriado — o art. 27.º(3) limita esse trabalho a 8 horas",
    warningArt86Headcount:
      "o desconto de INSS do art. 86.º exige {{max}} trabalhadores ou menos — este processamento tem {{count}}; o direito ao desconto cessa enquanto exceder {{max}}",
    title: "Processar Folha",
    freePlanNotice:
      "Está no plano gratuito. Prepare e reveja a folha à vontade — finalizar exige uma subscrição.",
    ...
    adjustHoursDesc:
      "Ajustar horas e pagamento adicional para cada funcionário",
    ...
    noEmployeesAdminHelp:
      "Não há funcionários ativos. Peça a um gestor com acesso a Pessoas para adicionar um.",
    ...
    warningExcessiveHours:
      "Média de {{hours}} horas/dia — excede limites seguros",
    ...
    taxSummaryDesc:
      "Imposto sobre rendimento e contribuições para segurança social (apenas leitura)",
    incomeTaxRate: "Imposto sobre Rendimento (10%)",
    inssEmployeeLabel: "INSS Funcionário (4%)",
    inssEmployerLabel: "INSS Empregador ({{rate}}%)",
    ...
    syncAttendanceDesc:
      "Carregar dados regulares, horas extra e atrasos da assiduidade para este período.",
    ...
    needDocsDesc:
      "Estes funcionários precisam de contratos ou números INSS. Pode processar a folha e adicionar documentos depois.",
    excluded: "Excluído",
    included: "Incluído",
    showMore: "Mostrar mais {{count}} funcionário(s)",
    showLess: "Mostrar menos",
    complianceAckText:
      "Compreendo que estes funcionários precisam de documentos para conformidade total. Irei adicionar os contratos/números INSS em falta dentro de 30 dias.",
    overrideReasonLabel:
      "Motivo para prosseguir (obrigatório para trilha de auditoria)",
    overrideReasonPlaceholder:
      "ex., Escritório do INSS fechado, a aguardar contrato do jurídico...",
    employeesIncluded:
      "{{included}} de {{total}} funcionários serão incluídos na folha",
    ...
    saveDraftDesc:
      "Guardar a folha atual como rascunho. Pode editar e processar depois.",
    period: "Período",
    ...
    employerCostHint: "Bruto + INSS Empregador ({{rate}}%)",
    ...
    aboutToSubmit:
      "Está prestes a submeter a folha para {{count}} funcionários para aprovação",
    ...
    differentAdminApprove:
      "Um administrador diferente deve aprovar antes do processamento",
    selfApprovalNext:
      "Pode aprovar esta folha você mesmo (autoaprovação ativa)",
    ...
    toastSubmittedDesc:
      "Folha para {{count}} funcionários submetida para aprovação.",
    ...
    toastDatesRequiredDesc:
      "Defina o período e data de pagamento antes de processar.",
    ...
    toastInvalidPayDateDesc:
      "A data de pagamento deve ser na ou após a data de fim do período.",
    toastDateOutOfBounds: "Intervalo de datas fora dos limites",
    toastDateOutOfBoundsDesc:
      "O período deve estar dentro dos últimos 2 anos e não mais de 1 mês no futuro.",
    toastComplianceRequired: "Reconhecimento de conformidade obrigatório",
    toastComplianceRequiredDesc:
      "Por favor reconheça os problemas de conformidade antes de prosseguir.",
    toastOverrideShort: "Motivo de substituição muito curto",
    toastOverrideShortDesc:
      "Por favor forneça pelo menos 10 caracteres explicando porque prossegue sem conformidade total.",
    toastSyncedAttendance:
      "Assiduidade sincronizada para {{count}} funcionário(s).",
    toastSyncedAttendanceWithLeave:
      "Assiduidade sincronizada para {{count}} funcionário(s). Licença aprovada creditada a {{leaveCount}} — a licença paga não é descontada.",
    toastSyncLeaveLookupFailed:
      "Não foi possível carregar as licenças aprovadas, por isso a sincronização foi cancelada — caso contrário, funcionários de licença paga receberiam menos. Verifique a ligação e tente novamente.",
    toastSyncAttendanceNoData:
      "Nenhum registo de assiduidade encontrado para este período.",
    toastLoadFailed:
      "Falha ao carregar funcionários. Por favor atualize a página.",
    ...
    stepPeriodDesc:
      "Selecione as datas e a frequência para este processamento de folha.",
    stepEmployeesTitle: "A quem vai pagar?",
    stepEmployeesDesc:
      "Reveja e selecione os funcionários incluídos neste processamento.",
    stepHoursTitle: "Reveja horas e pagamento",
    stepHoursDesc:
      "Verifique os números antes de avançar para a revisão final.",
  ...
  deductions: {
    ...
    editDialogDescription:
      "Atualize esta dedução. O progresso do reembolso do adiantamento é mantido — o saldo restante só muda se alterar o montante total.",
    editDialogTitle: "Editar Dedução",
    editTotalHint:
      "Alterar o total mantém o que já foi reembolsado — o saldo restante passa a ser o novo total menos o montante já reembolsado.",
    saveChanges: "Guardar Alterações",
    totalAmountRequired:
      "Um adiantamento que acompanha um saldo precisa de um montante total superior a zero.",
    ...
    deductionsTableDescription:
      "Gerir deduções e adiantamentos dos funcionários",
    ...
    addDialogDescription:
      "Criar uma dedução recorrente ou adiantamento salarial",
  ...
  paymentOrders: {
    ...
    downloadedDescription:
      "Imprima, preencha o número da OT, assine e envie por email ao seu balcão bancário.",
  ...
  payrollHistory: {
    ...
    pendingApprovalDescription:
      "Processamentos de folha a aguardar revisão e aprovação por segunda pessoa",
    ...
    selfApproveWarning:
      "Foi você quem criou esta folha de pagamento. Verifique bem os valores antes de aprovar — mais ninguém irá revê-la.",
    nextStepsTitle: "Folha aprovada — o que se segue?",
    nextStepsDesc:
      "Os seus funcionários ainda não foram pagos. Estes são os próximos passos habituais.",
    ...
    approveDialogDescription:
      "Está prestes a aprovar este processamento. Isto irá:",
    ...
    approveCheckingAllocation:
      "A verificar alocação por projeto/financiamento...",
    approveUnassignedWarningTitle: "Alocação não atribuída detetada",
    approveUnassignedWarningDesc:
      "{{count}} funcionário(s) neste processamento não têm etiquetas de projeto/financiamento ({{amount}} bruto).",
    approveUnassignedConfirm:
      "Confirmo que estes montantes devem ser lançados como Não Atribuídos.",
    approving: "A aprovar...",
    approveAndProcess: "Aprovar e Processar",
    rejectDialogTitle: "Rejeitar Processamento de Folha",
    rejectDialogDescription:
      "Forneça um motivo para rejeitar este processamento. O submissor poderá rever e resubmeter.",
    employeesNet: "{{count}} funcionários, {{amount}} líquido",
    rejectionReasonLabel: "Motivo da Rejeição",
    rejectionReasonPlaceholder:
      "Explique porque este processamento está a ser rejeitado (mínimo 10 caracteres)...",
    rejectionReasonMinChars:
      "O motivo deve ter pelo menos 10 caracteres ({{count}}/10)",
    cancel: "Cancelar",
    ...
    toastApprovalBlockedDesc:
      "Por favor confirme as alocações não atribuídas antes de aprovar este processamento.",
    ...
    payslipDialog: {
      ...
      description:
        "Enviar recibos por email aos funcionários referentes a {{period}}",
      ...
      toastNoRecipientsDesc:
        "Por favor selecione pelo menos um funcionário com endereço de email.",
      ...
      toastSentIssuesDesc:
        "Enviados: {{sent}}, Falhados: {{failed}}, Ignorados: {{skipped}}",
      toastSendErrorDesc: "Falha ao enviar recibos. Por favor tente novamente.",
    },
  },
  bankTransfers: {
    completePostsPayment:
      "Isto marca a folha de pagamento como paga, atualiza os saldos das deduções e lança o pagamento bancário na contabilidade.",
    alsoMarkRunPaid:
      "Marcar também a folha de pagamento como paga (atualiza os saldos de adiantamentos e deduções recorrentes)",
    markCompleted: "Marcar como concluída",
    markCompletedDesc:
      "Confirme que o seu banco executou este lote de salários. Isto apenas atualiza o registo no Xefe — não contacta o banco.",
    markCompletedTitle: "Marcar transferência como concluída?",
    markFailed: "Marcar como falhada",
    markFailedDesc:
      "Registe que o seu banco rejeitou ou não executou este lote de salários. Isto apenas atualiza o registo no Xefe — pode marcá-la como concluída mais tarde se o banco processar uma nova tentativa.",
    ...
    recordBankTransferDesc:
      "Regista a transferência desta folha como pendente no Xefe. Não é enviado dinheiro — gere os ficheiros bancários, entregue-os ou envie-os por email ao seu banco, e depois marque aqui a transferência como concluída.",
    recordTransfer: "Registar Transferência",
    toastRunMarkedPaid: "Folha de pagamento marcada como paga.",
    toastRunPaidError:
      "A transferência foi marcada como concluída, mas falhou a marcação da folha de pagamento como paga. Pode marcá-la como paga a partir do Histórico da Folha.",
    toastStatusUpdateError:
      "Falha ao atualizar o estado da transferência. Por favor tente novamente.",
    title: "Transferências Bancárias",
    subtitle:
      "Gerir transferências bancárias de folha e histórico de transações",
    coverEmail: {
      title: "Agora envie o email ao banco",
      description:
        "O BNU executa lotes salariais por instrução enviada por email. Para o BNCTL, este pacote é de melhor esforço até confirmação do balcão. Envie o ficheiro e anexe a folha Ordem de Pagamento impressa e assinada.",
    ...
    generateBankFilesDesc:
      "Gerar ficheiros específicos de cada banco para pagamentos de salários (BNU, Mandiri, ANZ, BNCTL)",
    ...
    initiateBankTransferDesc:
      "Configurar uma nova transferência bancária de folha",
    ...
    createFirstTransfer:
      "Crie a sua primeira transferência processando a folha e iniciando uma transferência bancária.",
    adjustFilters: "Tente ajustar os filtros.",
    amount: "Montante",
    employees: "Funcionários",
    ...
    toastErrorTitle: "Erro",
    toastLoadError:
      "Falha ao carregar transferências. Por favor atualize a página.",
    toastEmployeesLoading: "Os funcionários ainda estão a carregar",
    toastSelectRunAndBank:
      "Por favor selecione um processamento e pelo menos um banco.",
    toastRunNotFound: "Processamento selecionado não encontrado.",
    toastBankFilesSuccess:
      "Gerados {{count}} ficheiro(s) bancário(s) com sucesso.",
    toastBankFilesSuccessWithExcluded:
      "Gerados {{count}} ficheiro(s) bancário(s). {{excluded}} funcionário(s) pagos em dinheiro ou por um banco não suportado não foram incluídos.",
    toastBankFilesError:
      "Falha ao gerar ficheiros bancários. Por favor tente novamente.",
    toastBankDetailsError:
      "Verifique os dados bancários da empresa e dos funcionários e tente novamente.",
    toastPayrollDataError:
      "Não foi possível carregar alguns registos de funcionários da folha. Atualize a página antes de gerar ficheiros.",
    bankDetailsRequired:
      "Adicione uma conta bancária válida para salários e complete os dados bancários dos funcionários.",
    missingEmployeeRecordsNotice:
      "Não foi possível carregar {{count}} registo(s) de funcionários da folha. Atualize antes de gerar ficheiros bancários.",
    excludedEmployeesNotice:
      "{{count}} funcionário(s) recebem em dinheiro ou usam um banco sem formato suportado e não serão incluídos.",
    ...
    toastTransferSuccessDesc:
      "Transferência bancária {{reference}} iniciada com sucesso.",
    toastTransferRecordedDesc:
      "A transferência {{reference}} foi registada como pendente. Envie o ficheiro ou pacote ao banco e depois marque-a como concluída aqui.",
    toastMarkedCompleted:
      "A transferência {{reference}} foi concluída e o pagamento da folha foi lançado.",
    toastMarkedFailed:
      "A transferência {{reference}} foi marcada como falhada.",
    toastTransferError:
      "Falha ao iniciar transferência. Por favor tente novamente.",
  ...
  taxReports: {
    ...
    inssArrearsNotice:
      "O pagamento em atraso à Segurança Social vence juros de 1% por mês ou fração (DL 20/2017, art. 39.º).",
    inssArrearsEstimate:
      "Estimativa até agora para {{period}}: US$ {{amount}} ({{months}} mês/meses).",
    title: "Impostos e INSS da Folha",
    subtitle:
      "Centro de conformidade de Timor-Leste para IRT (ATTL) e declarações mensais de INSS.",
    actionRequired: "Ação necessária",
    onTrack: "Em dia",
    upcomingDeadlines: "Prazos",
    upcomingDeadlinesDesc:
      "Reveja datas de declaração atuais e em atraso. Confirme-as sempre com as orientações atuais da ATTL/INSS.",
    ...
    attlDesc:
      "Gerar, exportar (CSV/PDF) e acompanhar declarações mensais de Imposto sobre Rendimento do Trabalho.",
    ...
    formC: {
      ...
      workpaper: {
        ...
        summaryDesc:
          "Linhas 135–220 calculadas a partir da contabilidade mapeada, dos seus ajustamentos e créditos",
        grossIncome: "Rendimento bruto (linha 05)",
        totalExpenses: "Total de despesas (linha 135)",
        netIncome: "Resultado líquido / prejuízo (linha 140)",
        lossApplied: "Prejuízo utilizado este ano",
        taxableIncome: "Rendimento tributável (linha 150)",
        tax: "Imposto sobre o rendimento (linha 165)",
        totalCredits: "Total de créditos (linha 215)",
        taxOwing: "Imposto a pagar / pago em excesso (linha 220)",
        overpaid: "Pago em excesso — assinale o 'R' no formulário oficial",
        linesTitle: "Rendimentos e despesas (linhas 05–110)",
        linesDesc:
          "Contas do razão mapeadas para os números de linha oficiais — reclassifique com um ajustamento abaixo",
        colLine: "Linha",
        colDescription: "Descrição",
        colFromBooks: "Da contabilidade",
        colAdjustment: "Ajustamento",
        colAmount: "Valor do formulário",
        lines: {
          l05: "Rendimento total/bruto",
          l10: "Compras — inventário e mercadorias",
          l15: "Depreciação fiscalmente dedutível",
          l20: "Amortização de intangíveis",
          l25: "Créditos incobráveis",
          l30: "Perdas cambiais",
          l35: "Salários e vencimentos",
          l40: "Despesas com empreiteiros e subempreiteiros",
          l45: "Despesas de comissões",
          l50: "Rendas e/ou locações",
          l55: "Despesas com veículos",
          l60: "Reparações e manutenção",
          l65: "Investigação e desenvolvimento",
          l70: "Bolsas, aprendizagem e formação",
          l75: "Royalties",
        ...
        adjustmentsDesc:
          "Valores com sinal adicionados a uma linha do formulário — use para itens fora do razão (incobráveis, remoção do salário do proprietário, reclassificações)",
        ...
        whtCreditsHint:
          "O NIF do pagador é obrigatório — sem ele o formulário não aceita o crédito.",
        payerTin: "NIF do pagador",
        wht: {
          royalties: "Rendimentos de royalties",
          rentalLandBuildings: "Arrendamento de terrenos e/ou edifícios",
          buildingConstruction: "Construção civil",
          constructionConsulting: "Serviços de consultoria de construção",
          airSeaTransport: "Serviços de transporte aéreo e marítimo",
          mining: "Mineração e serviços de apoio à mineração",
        },
        depreciationTitle: "Mapa de depreciações",
        depreciationDesc:
          "Do registo de ativos fixos, nas colunas do mapa oficial — anexar ao formulário",
        assetDescription: "Ativo",
        openingValue: "Valor a 1 de jan",
        purchaseCost: "Custo (se adquirido)",
        disposalProceeds: "Produto da alienação",
        rate: "Taxa",
        yearDepreciation: "Depreciação",
        closingValue: "Valor final",
        scheduleTotal: "Total do mapa",
        readinessTitle: "Anexos e revisão",
        saveProgress: "Guardar progresso",
        exportWorkpaper: "Exportar papel de trabalho",
        exportError: "Não foi possível exportar o papel de trabalho.",
        warningsTitle: "Avisos de revisão",
        warnings: {
          interestExcluded:
  ...
  guidance: {
    ...
    dashboardBody:
      "Esta é a sua base — uma visão rápida do que está a acontecer na sua empresa hoje. Verifique o estado da folha, reveja a conformidade e entre em qualquer módulo a partir daqui.",
    ...
    schedulingBody:
      "Acompanhe a assiduidade, gerir pedidos de licença, reveja folhas de ponto e configure turnos. Este é o seu hub diário para saber quem está e quem não está.",
    payrollTitle: "Bem-vindo à Folha de Pagamento.",
    payrollBody:
      "É aqui que prepara e processa a folha de pagamento cada mês. A lista de verificação abaixo guia-o por cada passo — dados dos funcionários, assiduidade, cálculos e aprovação. Quando tudo estiver verde, está pronto para processar.",
    moneyTitle: "Bem-vindo ao Dinheiro.",
    moneyBody:
      "Acompanhe o seu fluxo de caixa diário aqui — faturas enviadas, pagamentos recebidos e o que ainda está pendente. Crie faturas, registe pagamentos e mantenha os seus livros atualizados.",
  ...
  moduleDashboards: {
    ...
    people: {
      title: "Pessoas",
      seoDescription:
        "Funcionários, recrutamento, licenças e desempenho num só lugar.",
      subtitle:
        "{{count}} funcionários ativos. Encontre alguém ou veja o que precisa de si.",
      subtitleNoStaff:
        "Aceda às ferramentas de pessoas usadas pela sua equipa.",
      addEmployee: "Adicionar funcionário",
      searchPlaceholder:
        "Encontre alguém — nome, função ou número de identificação…",
    ...
    payroll: {
      title: "Folha de Pagamento",
      seoDescription:
        "Processe a folha, faça pagamentos e acompanhe os prazos de WIT e INSS.",
      ...
      allGood:
        "A folha está em dia — nada precisa de atenção antes do pagamento.",
      attention: {
        addTeamFirst: "Adicione a sua equipa para processar a primeira folha",
        employeeBlocking:
          "funcionário sem informação necessária para processar a folha",
        employeesBlocking:
          "funcionários sem informação necessária para processar a folha",
        leaveRequest: "pedido de licença à espera de aprovação",
        leaveRequests: "pedidos de licença à espera de aprovação",
    ...
    money: {
      ...
      newInvoice: "Nova fatura",
      allGood:
        "O fluxo de caixa está tranquilo — não há valores em atraso nem contas a vencer esta semana.",
      attention: {
        overdueInvoice:
          "Cobrar {{count}} fatura em atraso — {{amount}} atrasados",
        overdueInvoices:
          "Cobrar {{count}} faturas em atraso — {{amount}} atrasados",
    ...
    accounting: {
      title: "Contabilidade",
      seoDescription:
        "Lançamentos, estrutura de contas e demonstrações financeiras num só lugar.",
      summaryPosted: "Última folha lançada em {{date}} · {{amount}}.",
      summaryNotPosted: "A última folha ainda não foi lançada no razão.",
      summaryNoPayroll:
        "Reveja os lançamentos e mantenha o balancete em ordem.",
      newEntry: "Novo lançamento",
      reviewPayroll: "Rever lançamentos da folha",
      allGoodWithPayroll:
        "As contas estão equilibradas e a folha foi lançada — nada precisa de atenção.",
    ...
    reports: {
      ...
      families: {
        ...
        "attendance-reports":
          "Ausências, horas extra, pontualidade e tendências de tempo.",
        "department-reports":
          "Comparações de custos, alocações e relatórios da organização.",
  ...
  supplierRemittance: {
    deductionSuspended:
      "A retenção não entregue suspende a dedutibilidade da despesa subjacente (Lei 8/2008, Sec. 32.2) — entregue para manter a dedução.",
    errorTitle: "Não foi possível registar o pagamento do imposto",
    proofRequired:
      "Carregue o comprovativo bancário, recibo do BNU ou outro comprovativo de pagamento.",
    signInRequired: "Inicie sessão antes de registar um pagamento de imposto.",
    savedTitle: "Pagamento do imposto registado",
    savedDescription:
      "A remessa, o comprovativo e o lançamento contabilístico foram guardados em conjunto.",
    title: "Pagamento da retenção de fornecedores",
    description:
      "Acompanhe o imposto efetivamente pago à ATTL neste período. Entregar a declaração não o marca como pago.",
    ...
    dialogDescription:
      "Introduza o valor efetivamente pago e anexe um comprovativo independente. Pagamentos parciais continuam pendentes.",
    paymentDate: "Data de pagamento",
    ...
    proofHint:
      "PDF ou imagem, até 10 MB. É obrigatório porque a declaração, por si só, não comprova o pagamento.",
  },
  taxClearance: {
    title: "Certidão de situação fiscal",
    subtitle:
      "Peça no e-Tax da ATTL e acompanhe aqui o resultado oficial e o PDF.",
    purpose: {
    ...
    savedDescription:
      "Submeta-o no e-Tax da ATTL; o Xefe não o submete por si.",
    ...
    howDescription:
      "O Xefe orienta e regista o processo; não está ligado à ATTL e não pode submeter o pedido.",
    step1: "Abra o e-Tax da ATTL e escolha Certificate → Clearance Request.",
    step2:
      "Escolha Tax Clearance Certificate e o tipo exato de documento necessário.",
    step3: "Guarde o pedido no e-Tax e depois acompanhe-o no Xefe.",
    step4:
      "Quando a ATTL o emitir, descarregue o PDF e guarde aqui as datas de emissão e validade.",
    openEtax: "Abrir e-Tax da ATTL",
    officialGuide: "Guia oficial da ATTL",
    requestsTitle: "Pedidos de certidão",
    requestsDescription:
      "As datas e PDFs são introduzidos a partir de comprovativos da ATTL; o Xefe não presume a validade.",
    ...
    newDescription:
      "Primeiro submeta o pedido no e-Tax da ATTL. Este registo serve apenas para acompanhamento.",
    documentType: "Tipo de documento oficial",
    oneMonthWarning:
      "A ATTL informa que as certidões de um mês exigem coordenação com um funcionário da ATTL e justificação razoável.",
  ...
  cashAdvances: {
    ...
    subtitle:
      "Dinheiro entregue a um trabalhador antes dos recibos, acompanhado até ficar totalmente justificado.",
    savedTitle: "Adiantamento registado",
    savedDescription:
      "O valor fica na conta 1230 até ser justificado por recibos ou devolução de dinheiro.",
    errorTitle: "Não foi possível guardar o adiantamento",
    clearingSaved: "Justificação registada",
    clearingSavedDescription:
      "O recibo ou dinheiro devolvido reduziu a conta 1230.",
    new: "Novo adiantamento",
    scopeTitle: "Use o fluxo certo",
    scopeDescription:
      "Use esta página apenas quando uma pessoa identificada recebe dinheiro antes dos recibos. Use Despesas para compras diretas de caixa pequeno; empréstimos salariais ficam na Folha.",
    openExpenses: "Abrir Despesas",
    listTitle: "Adiantamentos por justificar",
    listDescription:
      "Itens em aberto precisam de recibos ou devolução do dinheiro não usado. Os registos e lançamentos são comprovativos imutáveis.",
    ...
    newDescription:
      "Registe quem recebeu o dinheiro, quando deve ser justificado e o comprovativo da entrega.",
  ...
  accountantPartners: {
    ...
    process: {
      ...
      steps: {
        choose: {
          ...
          description:
            "Escolha a firma parceira. O Xefe envia apenas o seu contacto e o nome da empresa para que a firma possa responder.",
        },
        agree: {
          title: "Combinar o serviço",
          description:
            "Confirme o âmbito, os prazos e os honorários diretamente com a firma, fora do software.",
        },
        review: {
          title: "Conceder acesso para revisão",
          description:
            "O proprietário concede um papel de contabilista restrito e pode revogá-lo a qualquer momento.",
        },
      },
    },
    access: {
    ...
    selection: {
      ...
      self: "Gerir por mim",
      selfDescription:
        "Mantenha o Xefe simples e convide um contabilista mais tarde.",
      primos: "Pedir contacto da firma parceira",
      primosDescription:
        "Depois de criar a empresa, o Xefe envia por email apenas o nome e os dados de contacto.",
      primosPrelaunch: "Escolher a firma parceira para mais tarde",
      primosPrelaunchDescription:
        "Isto guarda apenas a sua preferência. Nenhum pedido ou dado de contacto é enviado enquanto a parceria está a ser preparada.",
      ...
      ownerOnly:
        "Apenas o proprietário ou administrador da empresa pode pedir um contabilista.",
    ...
    connection: {
      ...
      requestNote:
        "A firma parceira receberá por email o nome da empresa e os dados de contacto. Nenhum registo é partilhado.",
      ...
      grantNote:
        "Isto concede à firma parceira acesso restrito à folha, dinheiro, contabilidade e relatórios. A firma será avisada por email.",
      ownerGrantOnly:
        "O pedido foi aceite. Apenas o proprietário pode conceder acesso aos registos.",
      revoke: "Revogar acesso",
      confirmGrantTitle: "Conceder acesso à firma parceira?",
      confirmGrantDescription:
        "A firma parceira será avisada por email e adicionada com um papel de contabilista restrito. Pode rever a folha e os registos financeiros, mas não pode gerir utilizadores, trabalhadores, faturação ou integrações.",
      confirmRevokeTitle: "Revogar o acesso do contabilista?",
      confirmRevokeDescription:
        "A firma parceira perderá imediatamente o acesso a esta empresa. Os seus registos e o trabalho anterior permanecem no Xefe.",
      saved: "Ligação ao contabilista atualizada.",
      error: "Não foi possível atualizar a ligação ao contabilista.",
      prelaunch: "Em breve",
      prelaunchNote:
        "A ligação à firma parceira está em preparação. Nenhum pedido, email ou dado de contacto será enviado até ser ativada.",
      prelaunchAction: "Ligação disponível em breve",
      bannerTitle: "A contabilidade com parceiro chega em breve",
      bannerDescription:
        "Ligue um contabilista para colaborar na folha, nos impostos e nos relatórios.",
    ...
    landing: {
      ...
      description:
        "O Xefe mantém-se simples no trabalho diário. Quando quiser apoio profissional, escolha a firma parceira e controle exatamente quando começa o acesso.",
      cta: "Conhecer o parceiro contabilístico",
    },
    cta: {
      title: "Quer um contabilista ao seu lado?",
      description:
        "Escolha a firma parceira agora ou continue a gerir o Xefe por si. Nada é partilhado até aprovar o acesso.",
    },
  },
  accountantPortfolio: {
    ...
    responseNotice:
      "O contacto da empresa será avisado por email da sua decisão.",
    awaitingTitle: "Aceite — a aguardar o proprietário",
    awaitingDescription:
      "A firma aceitou. O cliente deve agora conceder acesso no Xefe.",
    clientsTitle: "Clientes ligados",
    connectedDescription:
      "Abrir o espaço restrito de contabilista deste cliente.",
