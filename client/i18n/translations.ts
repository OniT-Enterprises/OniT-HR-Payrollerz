...
export const translations = {
  ...
  "tet": {
    ...
    "dashboard": {
      ...
      "botGreeting5": "Ha'u la presiza kafé atu servisu — de'it ita-nia pergunta sira.",
      "botGreeting6": "Ha'u lee payslip hotu ona, ita la presiza. Saida mak ita presiza?",
    ...
    "settings": {
      ...
      "advancedTax": {
        ...
        "disabledToast": "Fila fali ba fluxu simples — Xefe aplika valór seguru automátiku."
      },
    ...
    "hiring": {
      ...
      "offboarding": {
        ...
        "finalPay": {
          ...
          "sourceHint": "Uza saláriu fulan no data hahú servisu ne'ebé rai ona, ho loron servisu ikus iha kazu ne'e.",
          "lastDay": "Loron servisu ikus",
          "taxNote": "Tenke selu WIT tuir Lei Impostu Art. 1. Pagamentu universál Art. 56 ne'e la tama iha baze INSS. Rai kálkulu la halo no la selu saláriu.",
    ...
    "accounting": {
      "chartOfAccounts": {
        "title": "Planu Konta",
        "subtitle": "Konfigura kategoria konta ne'ebé Xefe uza ba saláriu, fatura no relatóriu (Plano de Contas).",
        ...
        "noAccountsDescription": "Xefe bele aumenta lista konta padraun Timor-Leste atu ita bele hahú sein konfigura kontabilidade rasik.",
    ...
    "money": {
      ...
      "invoices": {
        ...
        "resetLinkDescription": "Link atuál sei para funsiona kedas no ami sei kria link foun ida. Uza ida-ne'e se Ita fahe link ho ema ne'ebé sala.",
      ...
      "vendors": {
        ...
        "supplierTaxHelp": "Presiza de'it bainhira fatura bele sujeitu ba retensaun impostu fornesedor nian.",
      ...
      "bills": {
        ...
        "vendorTaxProfileRequired": "Tau rezidénsia fiskál no rejime fiskál ba fornesedor ne'e molok rai.",
        "petroleumUnsupported": "Kalkuladora doméstiku la suporta retensaun rejime petróleu.",
        "payerWithholds": "Ita nia negósiu reten impostu bainhira halo pagamentu.",
        "supplierSelfWithholds": "Fornesedor maka responsavel ba impostu; labele hamenus pagamentu.",
    ...
    "runPayroll": {
      ...
      "stepEmployeesDesc": "Reviza no hili trabalhador ne'ebé inklui iha prosesu ida-ne'e.",
    ...
    "taxReports": {
      ...
      "upcomingDeadlinesDesc": "Reviza data submisaun atuál no ne'ebé liu ona. Verifika sempre ho orientasaun ATTL/INSS atuál.",
    ...
    "supplierRemittance": {
      ...
      "description": "Akompaña impostu ne'ebé selu duni ba ATTL ba períodu ida-ne'e. Entrega deklarasaun la signifika katak selu ona.",
      ...
      "dialogDescription": "Hatama montante ne'ebé selu duni no aneksa prova pagamentu independente. Pagamentu parsial sei hela pendente.",
      "paymentDate": "Data pagamentu",
      ...
      "proofHint": "PDF ka imajen, to'o 10 MB. Obrigatóriu tanba deklarasaun deit la prova katak selu ona."
    },
    "taxClearance": {
      "title": "Sertidaun situasaun fiskál",
      "subtitle": "Husu iha e-Tax ATTL, depois akompaña rezultadu ofisiál no PDF iha ne'e.",
      "purpose": {
      ...
      "howDescription": "Xefe fó matadalan no rejista prosesu; Xefe la konekta ba ATTL no la bele submete pedidu.",
      "step1": "Loke e-Tax ATTL no hili Certificate → Clearance Request.",
      "step2": "Hili Tax Clearance Certificate no tipu dokumentu loos ne'ebé presiza.",
      "step3": "Rai pedidu iha e-Tax, depois akompaña iha Xefe.",
      "step4": "Bainhira ATTL emite, download PDF no rai data emisaun no espirasaun iha ne'e.",
      "openEtax": "Loke e-Tax ATTL",
      "officialGuide": "Matadalan ofisiál ATTL",
      "requestsTitle": "Pedidu sertidaun",
      "requestsDescription": "Data no PDF hatama tuir prova ATTL; Xefe la sukat rasik validade.",
      ...
      "newDescription": "Primeiru submete iha e-Tax ATTL. Rejistu ida-ne'e atu akompaña deit.",
      "documentType": "Tipu dokumentu ofisiál",
      "oneMonthWarning": "ATTL dehan sertidaun fulan ida presiza koordena ho funsionáriu ATTL no fó justifikasaun ne'ebé razoavel.",
    ...
    "cashAdvances": {
      ...
      "subtitle": "Osan ne'ebé fó ba funsionáriu molok iha resibu, akompaña to'o justifika hotu.",
      "savedTitle": "Adiantamentu rejista ona",
      "savedDescription": "Montante rai iha konta 1230 to'o resibu ka osan ne'ebé fila fali justifika hotu.",
      ...
      "scopeDescription": "Uza pájina ida-ne'e deit bainhira ema ne'ebé identifika simu osan molok iha resibu. Uza Despeza ba sosa direta ho petty cash; empréstimu saláriu hela iha Saláriu.",
      "openExpenses": "Loke Despeza",
      "listTitle": "Adiantamentu atu justifika",
      "listDescription": "Item ne'ebé nakloke presiza resibu ka osan ne'ebé la uza fila fali. Rejistu no lansu jornál mak prova ne'ebé la bele muda.",
      ...
      "newDescription": "Rejista sé mak simu osan, bainhira tenke justifika, no prova katak osan fó ona.",
    ...
    "accountantPartners": {
      ...
      "connection": {
        ...
        "bannerDescription": "Liga kontabilista ida atu servisu hamutuk iha saláriu, taxa no relatóriu.",
