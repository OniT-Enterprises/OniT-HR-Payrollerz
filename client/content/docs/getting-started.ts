        ...
        items: [
          {
            ...
            body: "Em Pessoas, introduza o essencial: nome e apelido, data de início, tipo de contrato, salário mensal e residência fiscal — residente ou não residente, porque define a taxa do imposto sobre salários. O email, a data de nascimento, o departamento e o cargo podem esperar. Para identificação, o Xefe pede o Bilhete de Identidade aos trabalhadores timorenses e o passaporte aos estrangeiros, mas esses números também são opcionais no início. Nada disso o impede de guardar o funcionário. O número do INSS é o primeiro a tratar, porque a declaração mensal do INSS não pode ser entregue sem ele — a inscrição é devida até à data de entrega da primeira declaração de remunerações que inclua esse trabalhador (DL 20/2017, art. 3.º(2)), e o Xefe identifica quem ainda não o tem antes de entregar.",
          },
          {
        ...
        items: [
          {
            ...
            body: "Iha Pessoal, hatama buat importante sira: naran no apelidu, data hahú, tipu kontratu, saláriu mensál no rezidénsia fiskál — rezidente ka la'ós rezidente, tanba ne'e mak define taxa impostu saláriu nian. Email, data moris, departamentu no kargu bele hein. Ba identifikasaun, Xefe husu Bilhete de Identidade ba traballadór timoroan no pasaporte ba estranjeiru, maibé númeru sira-ne'e mós opsionál iha inísiu. Buat sira-ne'e la taka dalan atu rai funsionáriu. Númeru INSS mak primeiru atu buka, tanba deklarasaun INSS mensál la bele entrega sem nia — inskrisaun tenke halo to'o data entrega deklarasaun remunerasaun primeiru ne'ebé inklui traballadór ne'e (DL 20/2017, Art. 3(2)), no Xefe fó sai naran ema ne'ebé seidauk iha molok ita entrega.",
          },
          {
