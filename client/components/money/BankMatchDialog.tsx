...
function MatchOptionsList({ matchOptions, onMatch, formatCurrency }: {
  matchOptions: MatchOption[]; onMatch: (option: MatchOption) => void; formatCurrency: (amount: number) => string;
}) {
  return (
    <div className="space-y-2">
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="max-h-[300px] overflow-y-auto">
          {loading ? (
            ...
            <MatchOptionsList matchOptions={matchOptions} onMatch={onMatch} formatCurrency={formatCurrency} />
          )}
        </div>
        <DialogFooter>
