...
import { payslipStrings, type PayslipLocale } from '@/components/payroll/payslipStrings';

export { payslipStrings, type PayslipLocale } from '@/components/payroll/payslipStrings';
