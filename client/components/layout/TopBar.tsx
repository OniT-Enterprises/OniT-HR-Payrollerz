...
import { TAX_DEADLINE_WINDOW_MONTHS, usePayrollTaxFilingsDueSoon } from "@/hooks/useTaxFiling";
...
function useNotificationCounts(hasPayroll: boolean, hasTimeleave: boolean, hasStaff: boolean): NotificationCounts {
  ...
  const { data: filingsDue = [] } = usePayrollTaxFilingsDueSoon(TAX_DEADLINE_WINDOW_MONTHS, hasPayroll && notificationsReady);
