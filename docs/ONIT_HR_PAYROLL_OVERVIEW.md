...
3. [Timor-Leste Specific Features](#timor-leste-specific-features)
4. [Technical Architecture](#technical-architecture)
5. [Benefits by Stakeholder](#benefits-by-stakeholder)
...
- Customizable employee fields for organization-specific data
- Advanced search and filtering across all employee attributes
...
- Automatic expiry tracking for:
  - Passports
  - Work permits / Visas
  - Electoral cards (Kartaun Eleitoral)
  - ID cards (Bilhete de Identidade)
  - Professional licenses
  - Social Security cards
- Email alerts before document expiration
...
- Automatic calculation of:
  - Base salary
  - Overtime (1.5x and 2x rates per TL law)
  - Allowances (transport, meals, housing, etc.)
  - Commissions and bonuses
  - INSS employee contribution (4%)
  - INSS employer contribution (6%)
...
- Payment methods:
  - Cash
  - Bank transfer
  - Mobile money (Telkomcel/Telemor)
  - Check
...
- Automatic entries from:
  ...
  - Bill creation (DR: Expense, CR: AP)
  - Bill payment (DR: AP, CR: Cash)
...
- **Tetum** - Full interface translation (first HR system with Tetum support)
- Language switching without logout
- Bilingual document generation (payslips, contracts, reports)
...
- Our Lady of Immaculate Conception (8 December)
- Christmas Day (25 December)

Automatic holiday detection for payroll and scheduling.

### Foreign Worker Compliance

- Work permit tracking with expiry alerts
- Visa type recording
- Nationality-based document requirements
- Foreign worker register for SEPFOPE reporting
- Automatic flagging of expiring permits
- Compliance dashboard for HR

### TL Labor Law Support

- Overtime calculation per Labor Code:
  - Weekday overtime: 1.5x
  - Weekend/holiday: 2x
- Minimum wage tracking
- Probation period management
- Contract type handling (fixed-term, permanent)
...
- HR Administrator training (4-8 hours)
- Payroll processor training (4 hours)
- Manager training (2 hours)
- Employee self-service orientation (1 hour)
- Training materials in English, Portuguese, Tetum
...
- Reach SMEs through telco sales force
...
1. **Request Demo**: See the system in action with your data
2. **Free Trial**: 14-day trial with full features
3. **Consultation**: Discuss your specific requirements

### Contact Information

**OniT Enterprises**

- Website: payroll.naroman.tl
- Email: [contact email]
- Phone: [phone number]
